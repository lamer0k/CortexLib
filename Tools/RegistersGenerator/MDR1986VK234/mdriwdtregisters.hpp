...
struct MDR_IWDT
{
  ...
  struct KR : public RegisterBase<0x40050000, 32, WriteMode>
  {
  ...
  template<typename... T> 
  using KRPack  = Register<0x40050000, 32, WriteMode, MDR_IWDTKRBase, T...> ;

  struct MDR_IWDTPRBase {} ;

  struct PR : public RegisterBase<0x40050004, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using PRPack  = Register<0x40050004, 32, ReadWriteMode, MDR_IWDTPRBase, T...> ;

  struct MDR_IWDTRLRBase {} ;

  struct RLR : public RegisterBase<0x40050008, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using RLRPack  = Register<0x40050008, 32, ReadWriteMode, MDR_IWDTRLRBase, T...> ;

  struct MDR_IWDTSRBase {} ;

  struct SR : public RegisterBase<0x4005000C, 32, ReadMode>
  {
  ...
  template<typename... T> 
  using SRPack  = Register<0x4005000C, 32, ReadMode, MDR_IWDTSRBase, T...> ;
