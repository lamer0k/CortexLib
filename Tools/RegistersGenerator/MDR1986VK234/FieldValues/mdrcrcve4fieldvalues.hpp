...
struct MDR_CRC_VE4_CTRL_DL_Size_Values: public RegisterField<Reg, offset, size, AccessMode> 
{
  ...
  using 16_bit = FieldValue<MDR_CRC_VE4_CTRL_DL_Size_Values, BaseType, 1U> ;
  using 32_bit = FieldValue<MDR_CRC_VE4_CTRL_DL_Size_Values, BaseType, 2U> ;
} ;
...
struct MDR_CRC_VE4_CTRL_DC_Size_Values: public RegisterField<Reg, offset, size, AccessMode> 
{
  ...
  using 16_bit = FieldValue<MDR_CRC_VE4_CTRL_DC_Size_Values, BaseType, 1U> ;
  using 32_bit = FieldValue<MDR_CRC_VE4_CTRL_DC_Size_Values, BaseType, 2U> ;
} ;
...
{
  using Value0 = FieldValue<MDR_CRC_VE4_STAT_FIFO_Empty_Values, BaseType, 0U> ;
  using Value1 = FieldValue<MDR_CRC_VE4_STAT_FIFO_Empty_Values, BaseType, 1U> ;
} ;

template <typename Reg, size_t offset, size_t size, typename AccessMode, typename BaseType> 
struct MDR_CRC_VE4_STAT_FIFO_Over_Values: public RegisterField<Reg, offset, size, AccessMode> 
{
  using Value0 = FieldValue<MDR_CRC_VE4_STAT_FIFO_Over_Values, BaseType, 0U> ;
  using Value1 = FieldValue<MDR_CRC_VE4_STAT_FIFO_Over_Values, BaseType, 1U> ;
} ;
