...
struct MDR_SSP1
{
  ...
  struct CR0 : public RegisterBase<0x40000000, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using CR0Pack  = Register<0x40000000, 32, ReadWriteMode, MDR_SSP1CR0Base, T...> ;

  struct MDR_SSP1CR1Base {} ;

  struct CR1 : public RegisterBase<0x40000004, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using CR1Pack  = Register<0x40000004, 32, ReadWriteMode, MDR_SSP1CR1Base, T...> ;

  struct MDR_SSP1DRBase {} ;

  struct DR : public RegisterBase<0x40000008, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using DRPack  = Register<0x40000008, 32, ReadWriteMode, MDR_SSP1DRBase, T...> ;

  struct MDR_SSP1SRBase {} ;

  struct SR : public RegisterBase<0x4000000C, 32, ReadMode>
  {
  ...
  template<typename... T> 
  using SRPack  = Register<0x4000000C, 32, ReadMode, MDR_SSP1SRBase, T...> ;

  struct MDR_SSP1CPSRBase {} ;

  struct CPSR : public RegisterBase<0x40000010, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using CPSRPack  = Register<0x40000010, 32, ReadWriteMode, MDR_SSP1CPSRBase, T...> ;

  struct MDR_SSP1IMSCBase {} ;

  struct IMSC : public RegisterBase<0x40000014, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using IMSCPack  = Register<0x40000014, 32, ReadWriteMode, MDR_SSP1IMSCBase, T...> ;

  struct MDR_SSP1RISBase {} ;

  struct RIS : public RegisterBase<0x40000018, 32, ReadMode>
  {
  ...
  template<typename... T> 
  using RISPack  = Register<0x40000018, 32, ReadMode, MDR_SSP1RISBase, T...> ;

  struct MDR_SSP1MISBase {} ;

  struct MIS : public RegisterBase<0x4000001C, 32, ReadMode>
  {
  ...
  template<typename... T> 
  using MISPack  = Register<0x4000001C, 32, ReadMode, MDR_SSP1MISBase, T...> ;

  struct MDR_SSP1ICRBase {} ;

  struct ICR : public RegisterBase<0x40000020, 32, WriteMode>
  {
  ...
  template<typename... T> 
  using ICRPack  = Register<0x40000020, 32, WriteMode, MDR_SSP1ICRBase, T...> ;

  struct MDR_SSP1DMACRBase {} ;

  struct DMACR : public RegisterBase<0x40000024, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using DMACRPack  = Register<0x40000024, 32, ReadWriteMode, MDR_SSP1DMACRBase, T...> ;
