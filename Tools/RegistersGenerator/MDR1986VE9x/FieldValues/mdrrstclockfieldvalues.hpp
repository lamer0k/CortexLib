...
struct MDR_RST_CLOCK_CPU_CLOCK_CPU_C1_SEL_Values: public RegisterField<Reg, offset, size, AccessMode> 
{
  ...
  using HSI_DIV2 = FieldValue<MDR_RST_CLOCK_CPU_CLOCK_CPU_C1_SEL_Values, BaseType, 1U> ;
  using HSE = FieldValue<MDR_RST_CLOCK_CPU_CLOCK_CPU_C1_SEL_Values, BaseType, 2U> ;
  using HSE_DIV2 = FieldValue<MDR_RST_CLOCK_CPU_CLOCK_CPU_C1_SEL_Values, BaseType, 3U> ;
} ;
...
{
  using div1 = FieldValue<MDR_RST_CLOCK_CPU_CLOCK_CPU_C3_SEL_Values, BaseType, 7U> ;
...
struct MDR_RST_CLOCK_USB_CLOCK_USB_C1_SEL_Values: public RegisterField<Reg, offset, size, AccessMode> 
{
  ...
  using HSI_DIV2 = FieldValue<MDR_RST_CLOCK_USB_CLOCK_USB_C1_SEL_Values, BaseType, 1U> ;
  using HSE = FieldValue<MDR_RST_CLOCK_USB_CLOCK_USB_C1_SEL_Values, BaseType, 2U> ;
  using HSE_DIV2 = FieldValue<MDR_RST_CLOCK_USB_CLOCK_USB_C1_SEL_Values, BaseType, 3U> ;
} ;
