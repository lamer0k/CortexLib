...
struct MDR_TIMER2
{
  ...
  {
    using Value = MDR_TIMER2_CNT_Value_Values<MDR_TIMER2::CNT, 0, 32, ReadWriteMode, MDR_TIMER2CNTBase> ;
  ...
  {
    using Value = MDR_TIMER2_ARR_Value_Values<MDR_TIMER2::ARR, 0, 32, ReadWriteMode, MDR_TIMER2ARRBase> ;
  ...
  {
    using Value = MDR_TIMER2_CCR1_Value_Values<MDR_TIMER2::CCR1, 0, 32, ReadWriteMode, MDR_TIMER2CCR1Base> ;
  ...
  struct MDR_TIMER2DMA_RE1Base {} ;

  struct DMA_RE1 : public RegisterBase<0x40078080, 32, ReadWriteMode>
  {
    using FieldValues = <MDR_TIMER2::DMA_RE1, 0, 0, NoAccess, NoAccess> ;
  } ;

  template<typename... T> 
  using DMA_RE1Pack  = Register<0x40078080, 32, ReadWriteMode, MDR_TIMER2DMA_RE1Base, T...> ;

  struct MDR_TIMER2DMA_RE2Base {} ;

  struct DMA_RE2 : public RegisterBase<0x40078084, 32, ReadWriteMode>
  {
    using FieldValues = <MDR_TIMER2::DMA_RE2, 0, 0, NoAccess, NoAccess> ;
  } ;

  template<typename... T> 
  using DMA_RE2Pack  = Register<0x40078084, 32, ReadWriteMode, MDR_TIMER2DMA_RE2Base, T...> ;

  struct MDR_TIMER2DMA_RE3Base {} ;

  struct DMA_RE3 : public RegisterBase<0x40078088, 32, ReadWriteMode>
  {
    using FieldValues = <MDR_TIMER2::DMA_RE3, 0, 0, NoAccess, NoAccess> ;
  } ;

  template<typename... T> 
  using DMA_RE3Pack  = Register<0x40078088, 32, ReadWriteMode, MDR_TIMER2DMA_RE3Base, T...> ;

  struct MDR_TIMER2DMA_RE4Base {} ;

  struct DMA_RE4 : public RegisterBase<0x4007808C, 32, ReadWriteMode>
  {
    using FieldValues = <MDR_TIMER2::DMA_RE4, 0, 0, NoAccess, NoAccess> ;
  } ;

  template<typename... T> 
  using DMA_RE4Pack  = Register<0x4007808C, 32, ReadWriteMode, MDR_TIMER2DMA_RE4Base, T...> ;
