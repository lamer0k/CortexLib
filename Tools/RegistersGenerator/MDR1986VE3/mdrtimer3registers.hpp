...
struct MDR_TIMER3
{
  ...
  {
    using Value = MDR_TIMER3_CNT_Value_Values<MDR_TIMER3::CNT, 0, 32, ReadWriteMode, MDR_TIMER3CNTBase> ;
  ...
  {
    using Value = MDR_TIMER3_ARR_Value_Values<MDR_TIMER3::ARR, 0, 32, ReadWriteMode, MDR_TIMER3ARRBase> ;
  ...
  {
    using Value = MDR_TIMER3_CCR1_Value_Values<MDR_TIMER3::CCR1, 0, 32, ReadWriteMode, MDR_TIMER3CCR1Base> ;
  ...
  struct MDR_TIMER3DMA_RE1Base {} ;

  struct DMA_RE1 : public RegisterBase<0x40080080, 32, ReadWriteMode>
  {
    using FieldValues = <MDR_TIMER3::DMA_RE1, 0, 0, NoAccess, NoAccess> ;
  } ;

  template<typename... T> 
  using DMA_RE1Pack  = Register<0x40080080, 32, ReadWriteMode, MDR_TIMER3DMA_RE1Base, T...> ;

  struct MDR_TIMER3DMA_RE2Base {} ;

  struct DMA_RE2 : public RegisterBase<0x40080084, 32, ReadWriteMode>
  {
    using FieldValues = <MDR_TIMER3::DMA_RE2, 0, 0, NoAccess, NoAccess> ;
  } ;

  template<typename... T> 
  using DMA_RE2Pack  = Register<0x40080084, 32, ReadWriteMode, MDR_TIMER3DMA_RE2Base, T...> ;

  struct MDR_TIMER3DMA_RE3Base {} ;

  struct DMA_RE3 : public RegisterBase<0x40080088, 32, ReadWriteMode>
  {
    using FieldValues = <MDR_TIMER3::DMA_RE3, 0, 0, NoAccess, NoAccess> ;
  } ;

  template<typename... T> 
  using DMA_RE3Pack  = Register<0x40080088, 32, ReadWriteMode, MDR_TIMER3DMA_RE3Base, T...> ;

  struct MDR_TIMER3DMA_RE4Base {} ;

  struct DMA_RE4 : public RegisterBase<0x4008008C, 32, ReadWriteMode>
  {
    using FieldValues = <MDR_TIMER3::DMA_RE4, 0, 0, NoAccess, NoAccess> ;
  } ;

  template<typename... T> 
  using DMA_RE4Pack  = Register<0x4008008C, 32, ReadWriteMode, MDR_TIMER3DMA_RE4Base, T...> ;
