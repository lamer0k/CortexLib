...
struct MDR_PORTD
{
  ...
  struct MDR_PORTDSETTXBase {} ;

  struct SETTX : public RegisterBase<0x400C0020, 32, ReadWriteMode>
  {
    using Pin_%s = MDR_PORTD_SETTX_Pin_%s_Values<MDR_PORTD::SETTX, 0, 1, ReadWriteMode, MDR_PORTDSETTXBase> ;
    using FieldValues = MDR_PORTD_SETTX_Pin_%s_Values<MDR_PORTD::SETTX, 0, 0, NoAccess, NoAccess> ;
  } ;

  template<typename... T> 
  using SETTXPack  = Register<0x400C0020, 32, ReadWriteMode, MDR_PORTDSETTXBase, T...> ;

  struct MDR_PORTDCLRTXBase {} ;

  struct CLRTX : public RegisterBase<0x400C0024, 32, ReadWriteMode>
  {
    using Pin_%s = MDR_PORTD_CLRTX_Pin_%s_Values<MDR_PORTD::CLRTX, 0, 1, ReadWriteMode, MDR_PORTDCLRTXBase> ;
    using FieldValues = MDR_PORTD_CLRTX_Pin_%s_Values<MDR_PORTD::CLRTX, 0, 0, NoAccess, NoAccess> ;
  } ;

  template<typename... T> 
  using CLRTXPack  = Register<0x400C0024, 32, ReadWriteMode, MDR_PORTDCLRTXBase, T...> ;

  struct MDR_PORTDRDTXBase {} ;

  struct RDTX : public RegisterBase<0x400C0028, 32, ReadMode>
  {
    using Pin_%s = MDR_PORTD_RDTX_Pin_%s_Values<MDR_PORTD::RDTX, 0, 1, ReadMode, MDR_PORTDRDTXBase> ;
    using FieldValues = MDR_PORTD_RDTX_Pin_%s_Values<MDR_PORTD::RDTX, 0, 0, NoAccess, NoAccess> ;
  } ;

  template<typename... T> 
  using RDTXPack  = Register<0x400C0028, 32, ReadMode, MDR_PORTDRDTXBase, T...> ;
