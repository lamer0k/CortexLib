...
struct MDR_PORTE
{
  ...
  struct MDR_PORTESETTXBase {} ;

  struct SETTX : public RegisterBase<0x400C8020, 32, ReadWriteMode>
  {
    using Pin_%s = MDR_PORTE_SETTX_Pin_%s_Values<MDR_PORTE::SETTX, 0, 1, ReadWriteMode, MDR_PORTESETTXBase> ;
    using FieldValues = MDR_PORTE_SETTX_Pin_%s_Values<MDR_PORTE::SETTX, 0, 0, NoAccess, NoAccess> ;
  } ;

  template<typename... T> 
  using SETTXPack  = Register<0x400C8020, 32, ReadWriteMode, MDR_PORTESETTXBase, T...> ;

  struct MDR_PORTECLRTXBase {} ;

  struct CLRTX : public RegisterBase<0x400C8024, 32, ReadWriteMode>
  {
    using Pin_%s = MDR_PORTE_CLRTX_Pin_%s_Values<MDR_PORTE::CLRTX, 0, 1, ReadWriteMode, MDR_PORTECLRTXBase> ;
    using FieldValues = MDR_PORTE_CLRTX_Pin_%s_Values<MDR_PORTE::CLRTX, 0, 0, NoAccess, NoAccess> ;
  } ;

  template<typename... T> 
  using CLRTXPack  = Register<0x400C8024, 32, ReadWriteMode, MDR_PORTECLRTXBase, T...> ;

  struct MDR_PORTERDTXBase {} ;

  struct RDTX : public RegisterBase<0x400C8028, 32, ReadMode>
  {
    using Pin_%s = MDR_PORTE_RDTX_Pin_%s_Values<MDR_PORTE::RDTX, 0, 1, ReadMode, MDR_PORTERDTXBase> ;
    using FieldValues = MDR_PORTE_RDTX_Pin_%s_Values<MDR_PORTE::RDTX, 0, 0, NoAccess, NoAccess> ;
  } ;

  template<typename... T> 
  using RDTXPack  = Register<0x400C8028, 32, ReadMode, MDR_PORTERDTXBase, T...> ;
