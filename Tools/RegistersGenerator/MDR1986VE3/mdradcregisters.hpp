...
*                 auto-generated for MDR1986VE3 device.
*
*
*******************************************************************************/
...
struct MDR_ADC
{
  ...
  struct ADC1_TRIM : public RegisterBase<0x40088030, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using ADC1_TRIMPack  = Register<0x40088030, 32, ReadWriteMode, MDR_ADCADC1_TRIMBase, T...> ;
