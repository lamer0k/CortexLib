...
struct MDR_PORTA
{
  ...
  struct MDR_PORTASETTXBase {} ;

  struct SETTX : public RegisterBase<0x400A8020, 32, ReadWriteMode>
  {
    using Pin_%s = MDR_PORTA_SETTX_Pin_%s_Values<MDR_PORTA::SETTX, 0, 1, ReadWriteMode, MDR_PORTASETTXBase> ;
    using FieldValues = MDR_PORTA_SETTX_Pin_%s_Values<MDR_PORTA::SETTX, 0, 0, NoAccess, NoAccess> ;
  } ;

  template<typename... T> 
  using SETTXPack  = Register<0x400A8020, 32, ReadWriteMode, MDR_PORTASETTXBase, T...> ;

  struct MDR_PORTACLRTXBase {} ;

  struct CLRTX : public RegisterBase<0x400A8024, 32, ReadWriteMode>
  {
    using Pin_%s = MDR_PORTA_CLRTX_Pin_%s_Values<MDR_PORTA::CLRTX, 0, 1, ReadWriteMode, MDR_PORTACLRTXBase> ;
    using FieldValues = MDR_PORTA_CLRTX_Pin_%s_Values<MDR_PORTA::CLRTX, 0, 0, NoAccess, NoAccess> ;
  } ;

  template<typename... T> 
  using CLRTXPack  = Register<0x400A8024, 32, ReadWriteMode, MDR_PORTACLRTXBase, T...> ;

  struct MDR_PORTARDTXBase {} ;

  struct RDTX : public RegisterBase<0x400A8028, 32, ReadMode>
  {
    using Pin_%s = MDR_PORTA_RDTX_Pin_%s_Values<MDR_PORTA::RDTX, 0, 1, ReadMode, MDR_PORTARDTXBase> ;
    using FieldValues = MDR_PORTA_RDTX_Pin_%s_Values<MDR_PORTA::RDTX, 0, 0, NoAccess, NoAccess> ;
  } ;

  template<typename... T> 
  using RDTXPack  = Register<0x400A8028, 32, ReadMode, MDR_PORTARDTXBase, T...> ;
