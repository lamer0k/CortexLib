...
struct MDR_PORTF
{
  ...
  struct MDR_PORTFSETTXBase {} ;

  struct SETTX : public RegisterBase<0x400E8020, 32, ReadWriteMode>
  {
    using Pin_%s = MDR_PORTF_SETTX_Pin_%s_Values<MDR_PORTF::SETTX, 0, 1, ReadWriteMode, MDR_PORTFSETTXBase> ;
    using FieldValues = MDR_PORTF_SETTX_Pin_%s_Values<MDR_PORTF::SETTX, 0, 0, NoAccess, NoAccess> ;
  } ;

  template<typename... T> 
  using SETTXPack  = Register<0x400E8020, 32, ReadWriteMode, MDR_PORTFSETTXBase, T...> ;

  struct MDR_PORTFCLRTXBase {} ;

  struct CLRTX : public RegisterBase<0x400E8024, 32, ReadWriteMode>
  {
    using Pin_%s = MDR_PORTF_CLRTX_Pin_%s_Values<MDR_PORTF::CLRTX, 0, 1, ReadWriteMode, MDR_PORTFCLRTXBase> ;
    using FieldValues = MDR_PORTF_CLRTX_Pin_%s_Values<MDR_PORTF::CLRTX, 0, 0, NoAccess, NoAccess> ;
  } ;

  template<typename... T> 
  using CLRTXPack  = Register<0x400E8024, 32, ReadWriteMode, MDR_PORTFCLRTXBase, T...> ;

  struct MDR_PORTFRDTXBase {} ;

  struct RDTX : public RegisterBase<0x400E8028, 32, ReadMode>
  {
    using Pin_%s = MDR_PORTF_RDTX_Pin_%s_Values<MDR_PORTF::RDTX, 0, 1, ReadMode, MDR_PORTFRDTXBase> ;
    using FieldValues = MDR_PORTF_RDTX_Pin_%s_Values<MDR_PORTF::RDTX, 0, 0, NoAccess, NoAccess> ;
  } ;

  template<typename... T> 
  using RDTXPack  = Register<0x400E8028, 32, ReadMode, MDR_PORTFRDTXBase, T...> ;
