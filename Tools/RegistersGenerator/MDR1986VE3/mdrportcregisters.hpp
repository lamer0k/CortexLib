...
struct MDR_PORTC
{
  ...
  struct MDR_PORTCSETTXBase {} ;

  struct SETTX : public RegisterBase<0x400B8020, 32, ReadWriteMode>
  {
    using Pin_%s = MDR_PORTC_SETTX_Pin_%s_Values<MDR_PORTC::SETTX, 0, 1, ReadWriteMode, MDR_PORTCSETTXBase> ;
    using FieldValues = MDR_PORTC_SETTX_Pin_%s_Values<MDR_PORTC::SETTX, 0, 0, NoAccess, NoAccess> ;
  } ;

  template<typename... T> 
  using SETTXPack  = Register<0x400B8020, 32, ReadWriteMode, MDR_PORTCSETTXBase, T...> ;

  struct MDR_PORTCCLRTXBase {} ;

  struct CLRTX : public RegisterBase<0x400B8024, 32, ReadWriteMode>
  {
    using Pin_%s = MDR_PORTC_CLRTX_Pin_%s_Values<MDR_PORTC::CLRTX, 0, 1, ReadWriteMode, MDR_PORTCCLRTXBase> ;
    using FieldValues = MDR_PORTC_CLRTX_Pin_%s_Values<MDR_PORTC::CLRTX, 0, 0, NoAccess, NoAccess> ;
  } ;

  template<typename... T> 
  using CLRTXPack  = Register<0x400B8024, 32, ReadWriteMode, MDR_PORTCCLRTXBase, T...> ;

  struct MDR_PORTCRDTXBase {} ;

  struct RDTX : public RegisterBase<0x400B8028, 32, ReadMode>
  {
    using Pin_%s = MDR_PORTC_RDTX_Pin_%s_Values<MDR_PORTC::RDTX, 0, 1, ReadMode, MDR_PORTCRDTXBase> ;
    using FieldValues = MDR_PORTC_RDTX_Pin_%s_Values<MDR_PORTC::RDTX, 0, 0, NoAccess, NoAccess> ;
  } ;

  template<typename... T> 
  using RDTXPack  = Register<0x400B8028, 32, ReadMode, MDR_PORTCRDTXBase, T...> ;
