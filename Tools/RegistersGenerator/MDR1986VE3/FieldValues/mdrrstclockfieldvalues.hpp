...
*                 header file is auto-generated for MDR1986VE3 device.
*
*
*******************************************************************************/
...
template <typename Reg, size_t offset, size_t size, typename AccessMode, typename BaseType> 
struct MDR_RST_CLOCK_CLOCK_STATUS_HSE2_RDY_Values: public RegisterField<Reg, offset, size, AccessMode> 
{
  using NotReady = FieldValue<MDR_RST_CLOCK_CLOCK_STATUS_HSE2_RDY_Values, BaseType, 0U> ;
  using Ready = FieldValue<MDR_RST_CLOCK_CLOCK_STATUS_HSE2_RDY_Values, BaseType, 1U> ;
} ;
...
template <typename Reg, size_t offset, size_t size, typename AccessMode, typename BaseType> 
struct MDR_RST_CLOCK_HS_CONTROL_HSE2_ON_Values: public RegisterField<Reg, offset, size, AccessMode> 
{
  using Off = FieldValue<MDR_RST_CLOCK_HS_CONTROL_HSE2_ON_Values, BaseType, 0U> ;
  using On = FieldValue<MDR_RST_CLOCK_HS_CONTROL_HSE2_ON_Values, BaseType, 1U> ;
} ;

template <typename Reg, size_t offset, size_t size, typename AccessMode, typename BaseType> 
struct MDR_RST_CLOCK_HS_CONTROL_HSE2_BYP_Values: public RegisterField<Reg, offset, size, AccessMode> 
{
  using Off = FieldValue<MDR_RST_CLOCK_HS_CONTROL_HSE2_BYP_Values, BaseType, 0U> ;
  using On = FieldValue<MDR_RST_CLOCK_HS_CONTROL_HSE2_BYP_Values, BaseType, 1U> ;
} ;
...
template <typename Reg, size_t offset, size_t size, typename AccessMode, typename BaseType> 
struct MDR_RST_CLOCK_ADC_CLOCK_AUC_C1_SEL_Values: public RegisterField<Reg, offset, size, AccessMode> 
{
  using Value0 = FieldValue<MDR_RST_CLOCK_ADC_CLOCK_AUC_C1_SEL_Values, BaseType, 0U> ;
  using Value1 = FieldValue<MDR_RST_CLOCK_ADC_CLOCK_AUC_C1_SEL_Values, BaseType, 1U> ;
  using Value2 = FieldValue<MDR_RST_CLOCK_ADC_CLOCK_AUC_C1_SEL_Values, BaseType, 2U> ;
  using Value3 = FieldValue<MDR_RST_CLOCK_ADC_CLOCK_AUC_C1_SEL_Values, BaseType, 3U> ;
} ;

template <typename Reg, size_t offset, size_t size, typename AccessMode, typename BaseType> 
struct MDR_RST_CLOCK_ADC_CLOCK_AUC_C2_SEL_Values: public RegisterField<Reg, offset, size, AccessMode> 
{
  using AUC_C1 = FieldValue<MDR_RST_CLOCK_ADC_CLOCK_AUC_C2_SEL_Values, BaseType, 0U> ;
  using PLLCPUo = FieldValue<MDR_RST_CLOCK_ADC_CLOCK_AUC_C2_SEL_Values, BaseType, 1U> ;
  using PLLUSBo = FieldValue<MDR_RST_CLOCK_ADC_CLOCK_AUC_C2_SEL_Values, BaseType, 2U> ;
  using 0 = FieldValue<MDR_RST_CLOCK_ADC_CLOCK_AUC_C2_SEL_Values, BaseType, 3U> ;
} ;

template <typename Reg, size_t offset, size_t size, typename AccessMode, typename BaseType> 
struct MDR_RST_CLOCK_ADC_CLOCK_AUC_C3_SEL_Values: public RegisterField<Reg, offset, size, AccessMode> 
{
  using Value0 = FieldValue<MDR_RST_CLOCK_ADC_CLOCK_AUC_C3_SEL_Values, BaseType, 0U> ;
  using Value1 = FieldValue<MDR_RST_CLOCK_ADC_CLOCK_AUC_C3_SEL_Values, BaseType, 1U> ;
  using Value2 = FieldValue<MDR_RST_CLOCK_ADC_CLOCK_AUC_C3_SEL_Values, BaseType, 2U> ;
  using Value3 = FieldValue<MDR_RST_CLOCK_ADC_CLOCK_AUC_C3_SEL_Values, BaseType, 3U> ;
  using Value4 = FieldValue<MDR_RST_CLOCK_ADC_CLOCK_AUC_C3_SEL_Values, BaseType, 4U> ;
  using Value5 = FieldValue<MDR_RST_CLOCK_ADC_CLOCK_AUC_C3_SEL_Values, BaseType, 5U> ;
  using Value6 = FieldValue<MDR_RST_CLOCK_ADC_CLOCK_AUC_C3_SEL_Values, BaseType, 6U> ;
  using Value7 = FieldValue<MDR_RST_CLOCK_ADC_CLOCK_AUC_C3_SEL_Values, BaseType, 7U> ;
  using Value8 = FieldValue<MDR_RST_CLOCK_ADC_CLOCK_AUC_C3_SEL_Values, BaseType, 8U> ;
  using Value9 = FieldValue<MDR_RST_CLOCK_ADC_CLOCK_AUC_C3_SEL_Values, BaseType, 9U> ;
  using Value10 = FieldValue<MDR_RST_CLOCK_ADC_CLOCK_AUC_C3_SEL_Values, BaseType, 10U> ;
  using Value11 = FieldValue<MDR_RST_CLOCK_ADC_CLOCK_AUC_C3_SEL_Values, BaseType, 11U> ;
  using Value12 = FieldValue<MDR_RST_CLOCK_ADC_CLOCK_AUC_C3_SEL_Values, BaseType, 12U> ;
  using Value13 = FieldValue<MDR_RST_CLOCK_ADC_CLOCK_AUC_C3_SEL_Values, BaseType, 13U> ;
  using Value14 = FieldValue<MDR_RST_CLOCK_ADC_CLOCK_AUC_C3_SEL_Values, BaseType, 14U> ;
  using Value15 = FieldValue<MDR_RST_CLOCK_ADC_CLOCK_AUC_C3_SEL_Values, BaseType, 15U> ;
} ;

template <typename Reg, size_t offset, size_t size, typename AccessMode, typename BaseType> 
struct MDR_RST_CLOCK_ADC_CLOCK_AUC_CLK_EN_Values: public RegisterField<Reg, offset, size, AccessMode> 
{
  using Off = FieldValue<MDR_RST_CLOCK_ADC_CLOCK_AUC_CLK_EN_Values, BaseType, 0U> ;
  using On = FieldValue<MDR_RST_CLOCK_ADC_CLOCK_AUC_CLK_EN_Values, BaseType, 1U> ;
} ;
...
template <typename Reg, size_t offset, size_t size, typename AccessMode, typename BaseType> 
struct MDR_RST_CLOCK_PER_CLOCK_MIL1_CLK_EN_Values: public RegisterField<Reg, offset, size, AccessMode> 
{
  using Value0 = FieldValue<MDR_RST_CLOCK_PER_CLOCK_MIL1_CLK_EN_Values, BaseType, 0U> ;
  using Value1 = FieldValue<MDR_RST_CLOCK_PER_CLOCK_MIL1_CLK_EN_Values, BaseType, 1U> ;
} ;

template <typename Reg, size_t offset, size_t size, typename AccessMode, typename BaseType> 
struct MDR_RST_CLOCK_PER_CLOCK_MIL2_CLK_EN_Values: public RegisterField<Reg, offset, size, AccessMode> 
{
  using Value0 = FieldValue<MDR_RST_CLOCK_PER_CLOCK_MIL2_CLK_EN_Values, BaseType, 0U> ;
  using Value1 = FieldValue<MDR_RST_CLOCK_PER_CLOCK_MIL2_CLK_EN_Values, BaseType, 1U> ;
} ;
...
template <typename Reg, size_t offset, size_t size, typename AccessMode, typename BaseType> 
struct MDR_RST_CLOCK_PER_CLOCK_TIMER4_CLK_EN_Values: public RegisterField<Reg, offset, size, AccessMode> 
{
  using Value0 = FieldValue<MDR_RST_CLOCK_PER_CLOCK_TIMER4_CLK_EN_Values, BaseType, 0U> ;
  using Value1 = FieldValue<MDR_RST_CLOCK_PER_CLOCK_TIMER4_CLK_EN_Values, BaseType, 1U> ;
} ;
...
template <typename Reg, size_t offset, size_t size, typename AccessMode, typename BaseType> 
struct MDR_RST_CLOCK_PER_CLOCK_ARINC_RX_CLK_EN_Values: public RegisterField<Reg, offset, size, AccessMode> 
{
  using Value0 = FieldValue<MDR_RST_CLOCK_PER_CLOCK_ARINC_RX_CLK_EN_Values, BaseType, 0U> ;
  using Value1 = FieldValue<MDR_RST_CLOCK_PER_CLOCK_ARINC_RX_CLK_EN_Values, BaseType, 1U> ;
} ;
...
template <typename Reg, size_t offset, size_t size, typename AccessMode, typename BaseType> 
struct MDR_RST_CLOCK_PER_CLOCK_ARINC_TX_CLK_EN_Values: public RegisterField<Reg, offset, size, AccessMode> 
{
  using Value0 = FieldValue<MDR_RST_CLOCK_PER_CLOCK_ARINC_TX_CLK_EN_Values, BaseType, 0U> ;
  using Value1 = FieldValue<MDR_RST_CLOCK_PER_CLOCK_ARINC_TX_CLK_EN_Values, BaseType, 1U> ;
} ;
...
template <typename Reg, size_t offset, size_t size, typename AccessMode, typename BaseType> 
struct MDR_RST_CLOCK_PER_CLOCK_SPI3_CLK_EN_Values: public RegisterField<Reg, offset, size, AccessMode> 
{
  using Value0 = FieldValue<MDR_RST_CLOCK_PER_CLOCK_SPI3_CLK_EN_Values, BaseType, 0U> ;
  using Value1 = FieldValue<MDR_RST_CLOCK_PER_CLOCK_SPI3_CLK_EN_Values, BaseType, 1U> ;
} ;
...
template <typename Reg, size_t offset, size_t size, typename AccessMode, typename BaseType> 
struct MDR_RST_CLOCK_UART_CLOCK_TIM4_BRG_Values: public RegisterField<Reg, offset, size, AccessMode> 
{
  using Value0 = FieldValue<MDR_RST_CLOCK_UART_CLOCK_TIM4_BRG_Values, BaseType, 0U> ;
  using Value1 = FieldValue<MDR_RST_CLOCK_UART_CLOCK_TIM4_BRG_Values, BaseType, 1U> ;
  using Value2 = FieldValue<MDR_RST_CLOCK_UART_CLOCK_TIM4_BRG_Values, BaseType, 2U> ;
  using Value3 = FieldValue<MDR_RST_CLOCK_UART_CLOCK_TIM4_BRG_Values, BaseType, 3U> ;
  using Value4 = FieldValue<MDR_RST_CLOCK_UART_CLOCK_TIM4_BRG_Values, BaseType, 4U> ;
  using Value5 = FieldValue<MDR_RST_CLOCK_UART_CLOCK_TIM4_BRG_Values, BaseType, 5U> ;
  using Value6 = FieldValue<MDR_RST_CLOCK_UART_CLOCK_TIM4_BRG_Values, BaseType, 6U> ;
  using Value7 = FieldValue<MDR_RST_CLOCK_UART_CLOCK_TIM4_BRG_Values, BaseType, 7U> ;
} ;
...
template <typename Reg, size_t offset, size_t size, typename AccessMode, typename BaseType> 
struct MDR_RST_CLOCK_UART_CLOCK_TIM4_CLK_EN_Values: public RegisterField<Reg, offset, size, AccessMode> 
{
  using Off = FieldValue<MDR_RST_CLOCK_UART_CLOCK_TIM4_CLK_EN_Values, BaseType, 0U> ;
  using On = FieldValue<MDR_RST_CLOCK_UART_CLOCK_TIM4_CLK_EN_Values, BaseType, 1U> ;
} ;
...
template <typename Reg, size_t offset, size_t size, typename AccessMode, typename BaseType> 
struct MDR_RST_CLOCK_ETH_CLOCK_ETH_BRG_Values: public RegisterField<Reg, offset, size, AccessMode> 
{
} ;

template <typename Reg, size_t offset, size_t size, typename AccessMode, typename BaseType> 
struct MDR_RST_CLOCK_ETH_CLOCK_MIL_BRG_Values: public RegisterField<Reg, offset, size, AccessMode> 
{
  using Value0 = FieldValue<MDR_RST_CLOCK_ETH_CLOCK_MIL_BRG_Values, BaseType, 0U> ;
  using Value1 = FieldValue<MDR_RST_CLOCK_ETH_CLOCK_MIL_BRG_Values, BaseType, 1U> ;
  using Value2 = FieldValue<MDR_RST_CLOCK_ETH_CLOCK_MIL_BRG_Values, BaseType, 2U> ;
  using Value3 = FieldValue<MDR_RST_CLOCK_ETH_CLOCK_MIL_BRG_Values, BaseType, 3U> ;
  using Value4 = FieldValue<MDR_RST_CLOCK_ETH_CLOCK_MIL_BRG_Values, BaseType, 4U> ;
  using Value5 = FieldValue<MDR_RST_CLOCK_ETH_CLOCK_MIL_BRG_Values, BaseType, 5U> ;
  using Value6 = FieldValue<MDR_RST_CLOCK_ETH_CLOCK_MIL_BRG_Values, BaseType, 6U> ;
  using Value7 = FieldValue<MDR_RST_CLOCK_ETH_CLOCK_MIL_BRG_Values, BaseType, 7U> ;
} ;

template <typename Reg, size_t offset, size_t size, typename AccessMode, typename BaseType> 
struct MDR_RST_CLOCK_ETH_CLOCK_PHY_BRG_Values: public RegisterField<Reg, offset, size, AccessMode> 
{
  using Value0 = FieldValue<MDR_RST_CLOCK_ETH_CLOCK_PHY_BRG_Values, BaseType, 0U> ;
  using Value1 = FieldValue<MDR_RST_CLOCK_ETH_CLOCK_PHY_BRG_Values, BaseType, 1U> ;
  using Value2 = FieldValue<MDR_RST_CLOCK_ETH_CLOCK_PHY_BRG_Values, BaseType, 2U> ;
  using Value3 = FieldValue<MDR_RST_CLOCK_ETH_CLOCK_PHY_BRG_Values, BaseType, 3U> ;
  using Value4 = FieldValue<MDR_RST_CLOCK_ETH_CLOCK_PHY_BRG_Values, BaseType, 4U> ;
  using Value5 = FieldValue<MDR_RST_CLOCK_ETH_CLOCK_PHY_BRG_Values, BaseType, 5U> ;
  using Value6 = FieldValue<MDR_RST_CLOCK_ETH_CLOCK_PHY_BRG_Values, BaseType, 6U> ;
  using Value7 = FieldValue<MDR_RST_CLOCK_ETH_CLOCK_PHY_BRG_Values, BaseType, 7U> ;
} ;

template <typename Reg, size_t offset, size_t size, typename AccessMode, typename BaseType> 
struct MDR_RST_CLOCK_ETH_CLOCK_ETH_CLK_EN_Values: public RegisterField<Reg, offset, size, AccessMode> 
{
  using Off = FieldValue<MDR_RST_CLOCK_ETH_CLOCK_ETH_CLK_EN_Values, BaseType, 0U> ;
  using On = FieldValue<MDR_RST_CLOCK_ETH_CLOCK_ETH_CLK_EN_Values, BaseType, 1U> ;
} ;

template <typename Reg, size_t offset, size_t size, typename AccessMode, typename BaseType> 
struct MDR_RST_CLOCK_ETH_CLOCK_MIL_CLK_EN_Values: public RegisterField<Reg, offset, size, AccessMode> 
{
  using Off = FieldValue<MDR_RST_CLOCK_ETH_CLOCK_MIL_CLK_EN_Values, BaseType, 0U> ;
  using On = FieldValue<MDR_RST_CLOCK_ETH_CLOCK_MIL_CLK_EN_Values, BaseType, 1U> ;
} ;

template <typename Reg, size_t offset, size_t size, typename AccessMode, typename BaseType> 
struct MDR_RST_CLOCK_ETH_CLOCK_SLEEP_Values: public RegisterField<Reg, offset, size, AccessMode> 
{
  using Off = FieldValue<MDR_RST_CLOCK_ETH_CLOCK_SLEEP_Values, BaseType, 0U> ;
  using GoSLEEP = FieldValue<MDR_RST_CLOCK_ETH_CLOCK_SLEEP_Values, BaseType, 1U> ;
} ;

template <typename Reg, size_t offset, size_t size, typename AccessMode, typename BaseType> 
struct MDR_RST_CLOCK_ETH_CLOCK_PHY_CLK_EN_Values: public RegisterField<Reg, offset, size, AccessMode> 
{
  using Off = FieldValue<MDR_RST_CLOCK_ETH_CLOCK_PHY_CLK_EN_Values, BaseType, 0U> ;
  using On = FieldValue<MDR_RST_CLOCK_ETH_CLOCK_PHY_CLK_EN_Values, BaseType, 1U> ;
} ;

template <typename Reg, size_t offset, size_t size, typename AccessMode, typename BaseType> 
struct MDR_RST_CLOCK_ETH_CLOCK_PHY_CLK_SEL_Values: public RegisterField<Reg, offset, size, AccessMode> 
{
  using HSI = FieldValue<MDR_RST_CLOCK_ETH_CLOCK_PHY_CLK_SEL_Values, BaseType, 0U> ;
  using HSE = FieldValue<MDR_RST_CLOCK_ETH_CLOCK_PHY_CLK_SEL_Values, BaseType, 1U> ;
  using PLLCPUo = FieldValue<MDR_RST_CLOCK_ETH_CLOCK_PHY_CLK_SEL_Values, BaseType, 2U> ;
  using HSE2 = FieldValue<MDR_RST_CLOCK_ETH_CLOCK_PHY_CLK_SEL_Values, BaseType, 3U> ;
} ;

template <typename Reg, size_t offset, size_t size, typename AccessMode, typename BaseType> 
struct MDR_RST_CLOCK_ETH_CLOCK_ETH2_CLK_EN_Values: public RegisterField<Reg, offset, size, AccessMode> 
{
  using Off = FieldValue<MDR_RST_CLOCK_ETH_CLOCK_ETH2_CLK_EN_Values, BaseType, 0U> ;
  using On = FieldValue<MDR_RST_CLOCK_ETH_CLOCK_ETH2_CLK_EN_Values, BaseType, 1U> ;
} ;

template <typename Reg, size_t offset, size_t size, typename AccessMode, typename BaseType> 
struct MDR_RST_CLOCK_PER2_CLOCK_AUC_CLK_EN_Values: public RegisterField<Reg, offset, size, AccessMode> 
{
  using Value0 = FieldValue<MDR_RST_CLOCK_PER2_CLOCK_AUC_CLK_EN_Values, BaseType, 0U> ;
  using Value1 = FieldValue<MDR_RST_CLOCK_PER2_CLOCK_AUC_CLK_EN_Values, BaseType, 1U> ;
} ;

template <typename Reg, size_t offset, size_t size, typename AccessMode, typename BaseType> 
struct MDR_RST_CLOCK_PER2_CLOCK_LED_CLK_EN_Values: public RegisterField<Reg, offset, size, AccessMode> 
{
  using Value0 = FieldValue<MDR_RST_CLOCK_PER2_CLOCK_LED_CLK_EN_Values, BaseType, 0U> ;
  using Value1 = FieldValue<MDR_RST_CLOCK_PER2_CLOCK_LED_CLK_EN_Values, BaseType, 1U> ;
} ;

template <typename Reg, size_t offset, size_t size, typename AccessMode, typename BaseType> 
struct MDR_RST_CLOCK_PER2_CLOCK_KEY_CLK_EN_Values: public RegisterField<Reg, offset, size, AccessMode> 
{
  using Value0 = FieldValue<MDR_RST_CLOCK_PER2_CLOCK_KEY_CLK_EN_Values, BaseType, 0U> ;
  using Value1 = FieldValue<MDR_RST_CLOCK_PER2_CLOCK_KEY_CLK_EN_Values, BaseType, 1U> ;
} ;

template <typename Reg, size_t offset, size_t size, typename AccessMode, typename BaseType> 
struct MDR_RST_CLOCK_PER2_CLOCK_PORTG_CLK_EN_Values: public RegisterField<Reg, offset, size, AccessMode> 
{
  using Value0 = FieldValue<MDR_RST_CLOCK_PER2_CLOCK_PORTG_CLK_EN_Values, BaseType, 0U> ;
  using Value1 = FieldValue<MDR_RST_CLOCK_PER2_CLOCK_PORTG_CLK_EN_Values, BaseType, 1U> ;
} ;

template <typename Reg, size_t offset, size_t size, typename AccessMode, typename BaseType> 
struct MDR_RST_CLOCK_PER2_CLOCK_UART3_CLK_EN_Values: public RegisterField<Reg, offset, size, AccessMode> 
{
  using Value0 = FieldValue<MDR_RST_CLOCK_PER2_CLOCK_UART3_CLK_EN_Values, BaseType, 0U> ;
  using Value1 = FieldValue<MDR_RST_CLOCK_PER2_CLOCK_UART3_CLK_EN_Values, BaseType, 1U> ;
} ;

template <typename Reg, size_t offset, size_t size, typename AccessMode, typename BaseType> 
struct MDR_RST_CLOCK_PER2_CLOCK_UART4_CLK_EN_Values: public RegisterField<Reg, offset, size, AccessMode> 
{
  using Value0 = FieldValue<MDR_RST_CLOCK_PER2_CLOCK_UART4_CLK_EN_Values, BaseType, 0U> ;
  using Value1 = FieldValue<MDR_RST_CLOCK_PER2_CLOCK_UART4_CLK_EN_Values, BaseType, 1U> ;
} ;

template <typename Reg, size_t offset, size_t size, typename AccessMode, typename BaseType> 
struct MDR_RST_CLOCK_PER2_CLOCK_SSP4_CLK_EN_Values: public RegisterField<Reg, offset, size, AccessMode> 
{
  using Value0 = FieldValue<MDR_RST_CLOCK_PER2_CLOCK_SSP4_CLK_EN_Values, BaseType, 0U> ;
  using Value1 = FieldValue<MDR_RST_CLOCK_PER2_CLOCK_SSP4_CLK_EN_Values, BaseType, 1U> ;
} ;

template <typename Reg, size_t offset, size_t size, typename AccessMode, typename BaseType> 
struct MDR_RST_CLOCK_PER2_CLOCK_PORTH_CLK_EN_Values: public RegisterField<Reg, offset, size, AccessMode> 
{
  using Value0 = FieldValue<MDR_RST_CLOCK_PER2_CLOCK_PORTH_CLK_EN_Values, BaseType, 0U> ;
  using Value1 = FieldValue<MDR_RST_CLOCK_PER2_CLOCK_PORTH_CLK_EN_Values, BaseType, 1U> ;
} ;

template <typename Reg, size_t offset, size_t size, typename AccessMode, typename BaseType> 
struct MDR_RST_CLOCK_PER2_CLOCK_PORTI_CLK_EN_Values: public RegisterField<Reg, offset, size, AccessMode> 
{
  using Value0 = FieldValue<MDR_RST_CLOCK_PER2_CLOCK_PORTI_CLK_EN_Values, BaseType, 0U> ;
  using Value1 = FieldValue<MDR_RST_CLOCK_PER2_CLOCK_PORTI_CLK_EN_Values, BaseType, 1U> ;
} ;

template <typename Reg, size_t offset, size_t size, typename AccessMode, typename BaseType> 
struct MDR_RST_CLOCK_UART_SSP_CLOCK_UART3_BRG_Values: public RegisterField<Reg, offset, size, AccessMode> 
{
  using Value0 = FieldValue<MDR_RST_CLOCK_UART_SSP_CLOCK_UART3_BRG_Values, BaseType, 0U> ;
  using Value1 = FieldValue<MDR_RST_CLOCK_UART_SSP_CLOCK_UART3_BRG_Values, BaseType, 1U> ;
  using Value2 = FieldValue<MDR_RST_CLOCK_UART_SSP_CLOCK_UART3_BRG_Values, BaseType, 2U> ;
  using Value3 = FieldValue<MDR_RST_CLOCK_UART_SSP_CLOCK_UART3_BRG_Values, BaseType, 3U> ;
  using Value4 = FieldValue<MDR_RST_CLOCK_UART_SSP_CLOCK_UART3_BRG_Values, BaseType, 4U> ;
  using Value5 = FieldValue<MDR_RST_CLOCK_UART_SSP_CLOCK_UART3_BRG_Values, BaseType, 5U> ;
  using Value6 = FieldValue<MDR_RST_CLOCK_UART_SSP_CLOCK_UART3_BRG_Values, BaseType, 6U> ;
  using Value7 = FieldValue<MDR_RST_CLOCK_UART_SSP_CLOCK_UART3_BRG_Values, BaseType, 7U> ;
} ;

template <typename Reg, size_t offset, size_t size, typename AccessMode, typename BaseType> 
struct MDR_RST_CLOCK_UART_SSP_CLOCK_UART4_BRG_Values: public RegisterField<Reg, offset, size, AccessMode> 
{
  using Value0 = FieldValue<MDR_RST_CLOCK_UART_SSP_CLOCK_UART4_BRG_Values, BaseType, 0U> ;
  using Value1 = FieldValue<MDR_RST_CLOCK_UART_SSP_CLOCK_UART4_BRG_Values, BaseType, 1U> ;
  using Value2 = FieldValue<MDR_RST_CLOCK_UART_SSP_CLOCK_UART4_BRG_Values, BaseType, 2U> ;
  using Value3 = FieldValue<MDR_RST_CLOCK_UART_SSP_CLOCK_UART4_BRG_Values, BaseType, 3U> ;
  using Value4 = FieldValue<MDR_RST_CLOCK_UART_SSP_CLOCK_UART4_BRG_Values, BaseType, 4U> ;
  using Value5 = FieldValue<MDR_RST_CLOCK_UART_SSP_CLOCK_UART4_BRG_Values, BaseType, 5U> ;
  using Value6 = FieldValue<MDR_RST_CLOCK_UART_SSP_CLOCK_UART4_BRG_Values, BaseType, 6U> ;
  using Value7 = FieldValue<MDR_RST_CLOCK_UART_SSP_CLOCK_UART4_BRG_Values, BaseType, 7U> ;
} ;

template <typename Reg, size_t offset, size_t size, typename AccessMode, typename BaseType> 
struct MDR_RST_CLOCK_UART_SSP_CLOCK_SSP3_BRG_Values: public RegisterField<Reg, offset, size, AccessMode> 
{
  using Value0 = FieldValue<MDR_RST_CLOCK_UART_SSP_CLOCK_SSP3_BRG_Values, BaseType, 0U> ;
  using Value1 = FieldValue<MDR_RST_CLOCK_UART_SSP_CLOCK_SSP3_BRG_Values, BaseType, 1U> ;
  using Value2 = FieldValue<MDR_RST_CLOCK_UART_SSP_CLOCK_SSP3_BRG_Values, BaseType, 2U> ;
  using Value3 = FieldValue<MDR_RST_CLOCK_UART_SSP_CLOCK_SSP3_BRG_Values, BaseType, 3U> ;
  using Value4 = FieldValue<MDR_RST_CLOCK_UART_SSP_CLOCK_SSP3_BRG_Values, BaseType, 4U> ;
  using Value5 = FieldValue<MDR_RST_CLOCK_UART_SSP_CLOCK_SSP3_BRG_Values, BaseType, 5U> ;
  using Value6 = FieldValue<MDR_RST_CLOCK_UART_SSP_CLOCK_SSP3_BRG_Values, BaseType, 6U> ;
  using Value7 = FieldValue<MDR_RST_CLOCK_UART_SSP_CLOCK_SSP3_BRG_Values, BaseType, 7U> ;
} ;

template <typename Reg, size_t offset, size_t size, typename AccessMode, typename BaseType> 
struct MDR_RST_CLOCK_UART_SSP_CLOCK_UART3_CLK_EN_Values: public RegisterField<Reg, offset, size, AccessMode> 
{
  using Off = FieldValue<MDR_RST_CLOCK_UART_SSP_CLOCK_UART3_CLK_EN_Values, BaseType, 0U> ;
  using On = FieldValue<MDR_RST_CLOCK_UART_SSP_CLOCK_UART3_CLK_EN_Values, BaseType, 1U> ;
} ;

template <typename Reg, size_t offset, size_t size, typename AccessMode, typename BaseType> 
struct MDR_RST_CLOCK_UART_SSP_CLOCK_UART4_CLK_EN_Values: public RegisterField<Reg, offset, size, AccessMode> 
{
  using Off = FieldValue<MDR_RST_CLOCK_UART_SSP_CLOCK_UART4_CLK_EN_Values, BaseType, 0U> ;
  using On = FieldValue<MDR_RST_CLOCK_UART_SSP_CLOCK_UART4_CLK_EN_Values, BaseType, 1U> ;
} ;

template <typename Reg, size_t offset, size_t size, typename AccessMode, typename BaseType> 
struct MDR_RST_CLOCK_UART_SSP_CLOCK_SSP3_CLK_EN_Values: public RegisterField<Reg, offset, size, AccessMode> 
{
  using Off = FieldValue<MDR_RST_CLOCK_UART_SSP_CLOCK_SSP3_CLK_EN_Values, BaseType, 0U> ;
  using On = FieldValue<MDR_RST_CLOCK_UART_SSP_CLOCK_SSP3_CLK_EN_Values, BaseType, 1U> ;
} ;
