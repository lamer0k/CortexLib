...
template <typename Reg, size_t offset, size_t size, typename AccessMode, typename BaseType> 
struct MDR_PORTD_SETTX_Pin_%s_Values: public RegisterField<Reg, offset, size, AccessMode> 
{
  using Inactive = FieldValue<MDR_PORTD_SETTX_Pin_%s_Values, BaseType, 0U> ;
  using Selected = FieldValue<MDR_PORTD_SETTX_Pin_%s_Values, BaseType, 1U> ;
} ;

template <typename Reg, size_t offset, size_t size, typename AccessMode, typename BaseType> 
struct MDR_PORTD_CLRTX_Pin_%s_Values: public RegisterField<Reg, offset, size, AccessMode> 
{
  using Inactive = FieldValue<MDR_PORTD_CLRTX_Pin_%s_Values, BaseType, 0U> ;
  using Selected = FieldValue<MDR_PORTD_CLRTX_Pin_%s_Values, BaseType, 1U> ;
} ;

template <typename Reg, size_t offset, size_t size, typename AccessMode, typename BaseType> 
struct MDR_PORTD_RDTX_Pin_%s_Values: public RegisterField<Reg, offset, size, AccessMode> 
{
  using Low = FieldValue<MDR_PORTD_RDTX_Pin_%s_Values, BaseType, 0U> ;
  using High = FieldValue<MDR_PORTD_RDTX_Pin_%s_Values, BaseType, 1U> ;
} ;
