...
*                 is auto-generated for MDR1986VE3 device.
*
*
*******************************************************************************/
...
template <typename Reg, size_t offset, size_t size, typename AccessMode, typename BaseType> 
struct MDR_BKP_REG_0E_StandAlone_Values: public RegisterField<Reg, offset, size, AccessMode> 
{
  using Disable = FieldValue<MDR_BKP_REG_0E_StandAlone_Values, BaseType, 0U> ;
  using Enable = FieldValue<MDR_BKP_REG_0E_StandAlone_Values, BaseType, 1U> ;
} ;
...
{
  using 1.8 = FieldValue<MDR_BKP_REG_0E_Trim_DUcc_Values, BaseType, 0U> ;
  using 1.6 = FieldValue<MDR_BKP_REG_0E_Trim_DUcc_Values, BaseType, 1U> ;
  using 1.4 = FieldValue<MDR_BKP_REG_0E_Trim_DUcc_Values, BaseType, 2U> ;
  using Forbiden = FieldValue<MDR_BKP_REG_0E_Trim_DUcc_Values, BaseType, 3U> ;
} ;
