...
struct MDR_TIMER1_CNTRL_EVENT_SEL_Values: public RegisterField<Reg, offset, size, AccessMode> 
{
  ...
  using Fall_ETR = FieldValue<MDR_TIMER1_CNTRL_EVENT_SEL_Values, BaseType, 9U> ;
  using CNT_eq_ARR_TIM4 = FieldValue<MDR_TIMER1_CNTRL_EVENT_SEL_Values, BaseType, 10U> ;
} ;
