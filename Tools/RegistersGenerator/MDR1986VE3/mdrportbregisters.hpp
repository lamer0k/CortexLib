...
struct MDR_PORTB
{
  ...
  struct MDR_PORTBSETTXBase {} ;

  struct SETTX : public RegisterBase<0x400B0020, 32, ReadWriteMode>
  {
    using Pin_%s = MDR_PORTB_SETTX_Pin_%s_Values<MDR_PORTB::SETTX, 0, 1, ReadWriteMode, MDR_PORTBSETTXBase> ;
    using FieldValues = MDR_PORTB_SETTX_Pin_%s_Values<MDR_PORTB::SETTX, 0, 0, NoAccess, NoAccess> ;
  } ;

  template<typename... T> 
  using SETTXPack  = Register<0x400B0020, 32, ReadWriteMode, MDR_PORTBSETTXBase, T...> ;

  struct MDR_PORTBCLRTXBase {} ;

  struct CLRTX : public RegisterBase<0x400B0024, 32, ReadWriteMode>
  {
    using Pin_%s = MDR_PORTB_CLRTX_Pin_%s_Values<MDR_PORTB::CLRTX, 0, 1, ReadWriteMode, MDR_PORTBCLRTXBase> ;
    using FieldValues = MDR_PORTB_CLRTX_Pin_%s_Values<MDR_PORTB::CLRTX, 0, 0, NoAccess, NoAccess> ;
  } ;

  template<typename... T> 
  using CLRTXPack  = Register<0x400B0024, 32, ReadWriteMode, MDR_PORTBCLRTXBase, T...> ;

  struct MDR_PORTBRDTXBase {} ;

  struct RDTX : public RegisterBase<0x400B0028, 32, ReadMode>
  {
    using Pin_%s = MDR_PORTB_RDTX_Pin_%s_Values<MDR_PORTB::RDTX, 0, 1, ReadMode, MDR_PORTBRDTXBase> ;
    using FieldValues = MDR_PORTB_RDTX_Pin_%s_Values<MDR_PORTB::RDTX, 0, 0, NoAccess, NoAccess> ;
  } ;

  template<typename... T> 
  using RDTXPack  = Register<0x400B0028, 32, ReadMode, MDR_PORTBRDTXBase, T...> ;
