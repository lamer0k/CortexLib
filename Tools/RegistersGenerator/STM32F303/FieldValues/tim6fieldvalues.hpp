...
template <typename Reg, size_t offset, size_t size, typename AccessMode, typename BaseType> 
struct TIM6_CR1_UIFREMAP_Values: public RegisterField<Reg, offset, size, AccessMode> 
{
  using Value0 = FieldValue<TIM6_CR1_UIFREMAP_Values, BaseType, 0U> ;
  using Value1 = FieldValue<TIM6_CR1_UIFREMAP_Values, BaseType, 1U> ;
} ;
...
template <typename Reg, size_t offset, size_t size, typename AccessMode, typename BaseType> 
struct TIM6_CNT_UIFCPY_Values: public RegisterField<Reg, offset, size, AccessMode> 
{
  using Value0 = FieldValue<TIM6_CNT_UIFCPY_Values, BaseType, 0U> ;
  using Value1 = FieldValue<TIM6_CNT_UIFCPY_Values, BaseType, 1U> ;
} ;
