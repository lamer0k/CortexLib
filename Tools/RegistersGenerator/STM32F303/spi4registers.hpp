...
struct SPI4
{
  ...
  struct CR1 : public RegisterBase<0x40013C00, 32, ReadWriteMode>
  {
    ...
    using CRCL = SPI4_CR1_CRCL_Values<SPI4::CR1, 11, 1, ReadWriteMode, SPI4CR1Base> ;
  ...
  template<typename... T> 
  using CR1Pack  = Register<0x40013C00, 32, ReadWriteMode, SPI4CR1Base, T...> ;

  struct SPI4CR2Base {} ;

  struct CR2 : public RegisterBase<0x40013C04, 32, ReadWriteMode>
  {
    ...
    using NSSP = SPI4_CR2_NSSP_Values<SPI4::CR2, 3, 1, ReadWriteMode, SPI4CR2Base> ;
    ...
    using DS = SPI4_CR2_DS_Values<SPI4::CR2, 8, 4, ReadWriteMode, SPI4CR2Base> ;
    using FRXTH = SPI4_CR2_FRXTH_Values<SPI4::CR2, 12, 1, ReadWriteMode, SPI4CR2Base> ;
    using LDMA_RX = SPI4_CR2_LDMA_RX_Values<SPI4::CR2, 13, 1, ReadWriteMode, SPI4CR2Base> ;
    using LDMA_TX = SPI4_CR2_LDMA_TX_Values<SPI4::CR2, 14, 1, ReadWriteMode, SPI4CR2Base> ;
    using FieldValues = SPI4_CR2_LDMA_TX_Values<SPI4::CR2, 0, 0, NoAccess, NoAccess> ;
  } ;

  template<typename... T> 
  using CR2Pack  = Register<0x40013C04, 32, ReadWriteMode, SPI4CR2Base, T...> ;

  struct SPI4SRBase {} ;

  struct SR : public RegisterBase<0x40013C08, 32, ReadWriteMode>
  {
    ...
    using FRLVL = SPI4_SR_FRLVL_Values<SPI4::SR, 9, 2, ReadMode, SPI4SRBase> ;
    using FTLVL = SPI4_SR_FTLVL_Values<SPI4::SR, 11, 2, ReadMode, SPI4SRBase> ;
    using FieldValues = SPI4_SR_FTLVL_Values<SPI4::SR, 0, 0, NoAccess, NoAccess> ;
  } ;

  template<typename... T> 
  using SRPack  = Register<0x40013C08, 32, ReadWriteMode, SPI4SRBase, T...> ;

  struct SPI4DRBase {} ;

  struct DR : public RegisterBase<0x40013C0C, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using DRPack  = Register<0x40013C0C, 32, ReadWriteMode, SPI4DRBase, T...> ;

  struct SPI4CRCPRBase {} ;

  struct CRCPR : public RegisterBase<0x40013C10, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using CRCPRPack  = Register<0x40013C10, 32, ReadWriteMode, SPI4CRCPRBase, T...> ;

  struct SPI4RXCRCRBase {} ;

  struct RXCRCR : public RegisterBase<0x40013C14, 32, ReadMode>
  {
  ...
  template<typename... T> 
  using RXCRCRPack  = Register<0x40013C14, 32, ReadMode, SPI4RXCRCRBase, T...> ;

  struct SPI4TXCRCRBase {} ;

  struct TXCRCR : public RegisterBase<0x40013C18, 32, ReadMode>
  {
  ...
  template<typename... T> 
  using TXCRCRPack  = Register<0x40013C18, 32, ReadMode, SPI4TXCRCRBase, T...> ;

  struct SPI4I2SCFGRBase {} ;

  struct I2SCFGR : public RegisterBase<0x40013C1C, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using I2SCFGRPack  = Register<0x40013C1C, 32, ReadWriteMode, SPI4I2SCFGRBase, T...> ;

  struct SPI4I2SPRBase {} ;

  struct I2SPR : public RegisterBase<0x40013C20, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using I2SPRPack  = Register<0x40013C20, 32, ReadWriteMode, SPI4I2SPRBase, T...> ;
