...
struct GPIOH
{
  ...
  struct BRR : public RegisterBase<0x48001C28, 32, WriteMode>
  {
    ...
    using BR2 = GPIOH_BRR_BR2_Values<GPIOH::BRR, 2, 1, WriteMode, GPIOHBRRBase> ;
    using BR3 = GPIOH_BRR_BR3_Values<GPIOH::BRR, 3, 1, WriteMode, GPIOHBRRBase> ;
    using BR4 = GPIOH_BRR_BR4_Values<GPIOH::BRR, 4, 1, WriteMode, GPIOHBRRBase> ;
    using BR5 = GPIOH_BRR_BR5_Values<GPIOH::BRR, 5, 1, WriteMode, GPIOHBRRBase> ;
    using BR6 = GPIOH_BRR_BR6_Values<GPIOH::BRR, 6, 1, WriteMode, GPIOHBRRBase> ;
    using BR7 = GPIOH_BRR_BR7_Values<GPIOH::BRR, 7, 1, WriteMode, GPIOHBRRBase> ;
    using BR8 = GPIOH_BRR_BR8_Values<GPIOH::BRR, 8, 1, WriteMode, GPIOHBRRBase> ;
    using BR9 = GPIOH_BRR_BR9_Values<GPIOH::BRR, 9, 1, WriteMode, GPIOHBRRBase> ;
    using BR10 = GPIOH_BRR_BR10_Values<GPIOH::BRR, 10, 1, WriteMode, GPIOHBRRBase> ;
    using BR11 = GPIOH_BRR_BR11_Values<GPIOH::BRR, 11, 1, WriteMode, GPIOHBRRBase> ;
    using BR12 = GPIOH_BRR_BR12_Values<GPIOH::BRR, 12, 1, WriteMode, GPIOHBRRBase> ;
    using BR13 = GPIOH_BRR_BR13_Values<GPIOH::BRR, 13, 1, WriteMode, GPIOHBRRBase> ;
    using BR14 = GPIOH_BRR_BR14_Values<GPIOH::BRR, 14, 1, WriteMode, GPIOHBRRBase> ;
    using BR15 = GPIOH_BRR_BR15_Values<GPIOH::BRR, 15, 1, WriteMode, GPIOHBRRBase> ;
    using FieldValues = GPIOH_BRR_BR15_Values<GPIOH::BRR, 0, 0, NoAccess, NoAccess> ;
  } ;
