...
struct GPIOF
{
  ...
  struct MODER : public RegisterBase<0x40021400, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using MODERPack  = Register<0x40021400, 32, ReadWriteMode, GPIOFMODERBase, T...> ;

  struct GPIOFOTYPERBase {} ;

  struct OTYPER : public RegisterBase<0x40021404, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using OTYPERPack  = Register<0x40021404, 32, ReadWriteMode, GPIOFOTYPERBase, T...> ;

  struct GPIOFOSPEEDRBase {} ;

  struct OSPEEDR : public RegisterBase<0x40021408, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using OSPEEDRPack  = Register<0x40021408, 32, ReadWriteMode, GPIOFOSPEEDRBase, T...> ;

  struct GPIOFPUPDRBase {} ;

  struct PUPDR : public RegisterBase<0x4002140C, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using PUPDRPack  = Register<0x4002140C, 32, ReadWriteMode, GPIOFPUPDRBase, T...> ;

  struct GPIOFIDRBase {} ;

  struct IDR : public RegisterBase<0x40021410, 32, ReadMode>
  {
  ...
  template<typename... T> 
  using IDRPack  = Register<0x40021410, 32, ReadMode, GPIOFIDRBase, T...> ;

  struct GPIOFODRBase {} ;

  struct ODR : public RegisterBase<0x40021414, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using ODRPack  = Register<0x40021414, 32, ReadWriteMode, GPIOFODRBase, T...> ;

  struct GPIOFBSRRBase {} ;

  struct BSRR : public RegisterBase<0x40021418, 32, WriteMode>
  {
  ...
  template<typename... T> 
  using BSRRPack  = Register<0x40021418, 32, WriteMode, GPIOFBSRRBase, T...> ;

  struct GPIOFLCKRBase {} ;

  struct LCKR : public RegisterBase<0x4002141C, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using LCKRPack  = Register<0x4002141C, 32, ReadWriteMode, GPIOFLCKRBase, T...> ;

  struct GPIOFAFRLBase {} ;

  struct AFRL : public RegisterBase<0x40021420, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using AFRLPack  = Register<0x40021420, 32, ReadWriteMode, GPIOFAFRLBase, T...> ;

  struct GPIOFAFRHBase {} ;

  struct AFRH : public RegisterBase<0x40021424, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using AFRHPack  = Register<0x40021424, 32, ReadWriteMode, GPIOFAFRHBase, T...> ;
