...
struct SYSCFG
{
  ...
  {
    using MII_RMII_SEL = SYSCFG_PMC_MII_RMII_SEL_Values<SYSCFG::PMC, 23, 1, ReadWriteMode, SYSCFGPMCBase> ;
    using FieldValues = SYSCFG_PMC_MII_RMII_SEL_Values<SYSCFG::PMC, 0, 0, NoAccess, NoAccess> ;
  } ;
