...
template <typename Reg, size_t offset, size_t size, typename AccessMode, typename BaseType> 
struct UART4_SR_NF_Values: public RegisterField<Reg, offset, size, AccessMode> 
{
  using Value0 = FieldValue<UART4_SR_NF_Values, BaseType, 0U> ;
  using Value1 = FieldValue<UART4_SR_NF_Values, BaseType, 1U> ;
} ;
