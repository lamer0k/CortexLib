...
template <typename Reg, size_t offset, size_t size, typename AccessMode, typename BaseType> 
struct SYSCFG_PMC_MII_RMII_SEL_Values: public RegisterField<Reg, offset, size, AccessMode> 
{
  using Value0 = FieldValue<SYSCFG_PMC_MII_RMII_SEL_Values, BaseType, 0U> ;
  using Value1 = FieldValue<SYSCFG_PMC_MII_RMII_SEL_Values, BaseType, 1U> ;
} ;
