...
struct DMA2
{
  ...
  struct LIFCR : public RegisterBase<0x40026408, 32, ReadWriteMode>
  {
    using CTCIF3 = DMA2_LIFCR_CTCIF3_Values<DMA2::LIFCR, 27, 1, ReadWriteMode, DMA2LIFCRBase> ;
    using CHTIF3 = DMA2_LIFCR_CHTIF3_Values<DMA2::LIFCR, 26, 1, ReadWriteMode, DMA2LIFCRBase> ;
    using CTEIF3 = DMA2_LIFCR_CTEIF3_Values<DMA2::LIFCR, 25, 1, ReadWriteMode, DMA2LIFCRBase> ;
    using CDMEIF3 = DMA2_LIFCR_CDMEIF3_Values<DMA2::LIFCR, 24, 1, ReadWriteMode, DMA2LIFCRBase> ;
    using CFEIF3 = DMA2_LIFCR_CFEIF3_Values<DMA2::LIFCR, 22, 1, ReadWriteMode, DMA2LIFCRBase> ;
    using CTCIF2 = DMA2_LIFCR_CTCIF2_Values<DMA2::LIFCR, 21, 1, ReadWriteMode, DMA2LIFCRBase> ;
    using CHTIF2 = DMA2_LIFCR_CHTIF2_Values<DMA2::LIFCR, 20, 1, ReadWriteMode, DMA2LIFCRBase> ;
    using CTEIF2 = DMA2_LIFCR_CTEIF2_Values<DMA2::LIFCR, 19, 1, ReadWriteMode, DMA2LIFCRBase> ;
    using CDMEIF2 = DMA2_LIFCR_CDMEIF2_Values<DMA2::LIFCR, 18, 1, ReadWriteMode, DMA2LIFCRBase> ;
    using CFEIF2 = DMA2_LIFCR_CFEIF2_Values<DMA2::LIFCR, 16, 1, ReadWriteMode, DMA2LIFCRBase> ;
    using CTCIF1 = DMA2_LIFCR_CTCIF1_Values<DMA2::LIFCR, 11, 1, ReadWriteMode, DMA2LIFCRBase> ;
    using CHTIF1 = DMA2_LIFCR_CHTIF1_Values<DMA2::LIFCR, 10, 1, ReadWriteMode, DMA2LIFCRBase> ;
    using CTEIF1 = DMA2_LIFCR_CTEIF1_Values<DMA2::LIFCR, 9, 1, ReadWriteMode, DMA2LIFCRBase> ;
    using CDMEIF1 = DMA2_LIFCR_CDMEIF1_Values<DMA2::LIFCR, 8, 1, ReadWriteMode, DMA2LIFCRBase> ;
    using CFEIF1 = DMA2_LIFCR_CFEIF1_Values<DMA2::LIFCR, 6, 1, ReadWriteMode, DMA2LIFCRBase> ;
    using CTCIF0 = DMA2_LIFCR_CTCIF0_Values<DMA2::LIFCR, 5, 1, ReadWriteMode, DMA2LIFCRBase> ;
    using CHTIF0 = DMA2_LIFCR_CHTIF0_Values<DMA2::LIFCR, 4, 1, ReadWriteMode, DMA2LIFCRBase> ;
    using CTEIF0 = DMA2_LIFCR_CTEIF0_Values<DMA2::LIFCR, 3, 1, ReadWriteMode, DMA2LIFCRBase> ;
    using CDMEIF0 = DMA2_LIFCR_CDMEIF0_Values<DMA2::LIFCR, 2, 1, ReadWriteMode, DMA2LIFCRBase> ;
    using CFEIF0 = DMA2_LIFCR_CFEIF0_Values<DMA2::LIFCR, 0, 1, ReadWriteMode, DMA2LIFCRBase> ;
    using FieldValues = DMA2_LIFCR_CFEIF0_Values<DMA2::LIFCR, 0, 0, NoAccess, NoAccess> ;
  } ;

  template<typename... T> 
  using LIFCRPack  = Register<0x40026408, 32, ReadWriteMode, DMA2LIFCRBase, T...> ;

  struct DMA2HIFCRBase {} ;

  struct HIFCR : public RegisterBase<0x4002640C, 32, ReadWriteMode>
  {
    using CTCIF7 = DMA2_HIFCR_CTCIF7_Values<DMA2::HIFCR, 27, 1, ReadWriteMode, DMA2HIFCRBase> ;
    using CHTIF7 = DMA2_HIFCR_CHTIF7_Values<DMA2::HIFCR, 26, 1, ReadWriteMode, DMA2HIFCRBase> ;
    using CTEIF7 = DMA2_HIFCR_CTEIF7_Values<DMA2::HIFCR, 25, 1, ReadWriteMode, DMA2HIFCRBase> ;
    using CDMEIF7 = DMA2_HIFCR_CDMEIF7_Values<DMA2::HIFCR, 24, 1, ReadWriteMode, DMA2HIFCRBase> ;
    using CFEIF7 = DMA2_HIFCR_CFEIF7_Values<DMA2::HIFCR, 22, 1, ReadWriteMode, DMA2HIFCRBase> ;
    using CTCIF6 = DMA2_HIFCR_CTCIF6_Values<DMA2::HIFCR, 21, 1, ReadWriteMode, DMA2HIFCRBase> ;
    using CHTIF6 = DMA2_HIFCR_CHTIF6_Values<DMA2::HIFCR, 20, 1, ReadWriteMode, DMA2HIFCRBase> ;
    using CTEIF6 = DMA2_HIFCR_CTEIF6_Values<DMA2::HIFCR, 19, 1, ReadWriteMode, DMA2HIFCRBase> ;
    using CDMEIF6 = DMA2_HIFCR_CDMEIF6_Values<DMA2::HIFCR, 18, 1, ReadWriteMode, DMA2HIFCRBase> ;
    using CFEIF6 = DMA2_HIFCR_CFEIF6_Values<DMA2::HIFCR, 16, 1, ReadWriteMode, DMA2HIFCRBase> ;
    using CTCIF5 = DMA2_HIFCR_CTCIF5_Values<DMA2::HIFCR, 11, 1, ReadWriteMode, DMA2HIFCRBase> ;
    using CHTIF5 = DMA2_HIFCR_CHTIF5_Values<DMA2::HIFCR, 10, 1, ReadWriteMode, DMA2HIFCRBase> ;
    using CTEIF5 = DMA2_HIFCR_CTEIF5_Values<DMA2::HIFCR, 9, 1, ReadWriteMode, DMA2HIFCRBase> ;
    using CDMEIF5 = DMA2_HIFCR_CDMEIF5_Values<DMA2::HIFCR, 8, 1, ReadWriteMode, DMA2HIFCRBase> ;
    using CFEIF5 = DMA2_HIFCR_CFEIF5_Values<DMA2::HIFCR, 6, 1, ReadWriteMode, DMA2HIFCRBase> ;
    using CTCIF4 = DMA2_HIFCR_CTCIF4_Values<DMA2::HIFCR, 5, 1, ReadWriteMode, DMA2HIFCRBase> ;
    using CHTIF4 = DMA2_HIFCR_CHTIF4_Values<DMA2::HIFCR, 4, 1, ReadWriteMode, DMA2HIFCRBase> ;
    using CTEIF4 = DMA2_HIFCR_CTEIF4_Values<DMA2::HIFCR, 3, 1, ReadWriteMode, DMA2HIFCRBase> ;
    using CDMEIF4 = DMA2_HIFCR_CDMEIF4_Values<DMA2::HIFCR, 2, 1, ReadWriteMode, DMA2HIFCRBase> ;
    using CFEIF4 = DMA2_HIFCR_CFEIF4_Values<DMA2::HIFCR, 0, 1, ReadWriteMode, DMA2HIFCRBase> ;
    using FieldValues = DMA2_HIFCR_CFEIF4_Values<DMA2::HIFCR, 0, 0, NoAccess, NoAccess> ;
  } ;

  template<typename... T> 
  using HIFCRPack  = Register<0x4002640C, 32, ReadWriteMode, DMA2HIFCRBase, T...> ;
