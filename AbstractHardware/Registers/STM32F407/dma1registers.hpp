...
struct DMA1
{
  ...
  struct LIFCR : public RegisterBase<0x40026008, 32, ReadWriteMode>
  {
    using CTCIF3 = DMA1_LIFCR_CTCIF3_Values<DMA1::LIFCR, 27, 1, ReadWriteMode, DMA1LIFCRBase> ;
    using CHTIF3 = DMA1_LIFCR_CHTIF3_Values<DMA1::LIFCR, 26, 1, ReadWriteMode, DMA1LIFCRBase> ;
    using CTEIF3 = DMA1_LIFCR_CTEIF3_Values<DMA1::LIFCR, 25, 1, ReadWriteMode, DMA1LIFCRBase> ;
    using CDMEIF3 = DMA1_LIFCR_CDMEIF3_Values<DMA1::LIFCR, 24, 1, ReadWriteMode, DMA1LIFCRBase> ;
    using CFEIF3 = DMA1_LIFCR_CFEIF3_Values<DMA1::LIFCR, 22, 1, ReadWriteMode, DMA1LIFCRBase> ;
    using CTCIF2 = DMA1_LIFCR_CTCIF2_Values<DMA1::LIFCR, 21, 1, ReadWriteMode, DMA1LIFCRBase> ;
    using CHTIF2 = DMA1_LIFCR_CHTIF2_Values<DMA1::LIFCR, 20, 1, ReadWriteMode, DMA1LIFCRBase> ;
    using CTEIF2 = DMA1_LIFCR_CTEIF2_Values<DMA1::LIFCR, 19, 1, ReadWriteMode, DMA1LIFCRBase> ;
    using CDMEIF2 = DMA1_LIFCR_CDMEIF2_Values<DMA1::LIFCR, 18, 1, ReadWriteMode, DMA1LIFCRBase> ;
    using CFEIF2 = DMA1_LIFCR_CFEIF2_Values<DMA1::LIFCR, 16, 1, ReadWriteMode, DMA1LIFCRBase> ;
    using CTCIF1 = DMA1_LIFCR_CTCIF1_Values<DMA1::LIFCR, 11, 1, ReadWriteMode, DMA1LIFCRBase> ;
    using CHTIF1 = DMA1_LIFCR_CHTIF1_Values<DMA1::LIFCR, 10, 1, ReadWriteMode, DMA1LIFCRBase> ;
    using CTEIF1 = DMA1_LIFCR_CTEIF1_Values<DMA1::LIFCR, 9, 1, ReadWriteMode, DMA1LIFCRBase> ;
    using CDMEIF1 = DMA1_LIFCR_CDMEIF1_Values<DMA1::LIFCR, 8, 1, ReadWriteMode, DMA1LIFCRBase> ;
    using CFEIF1 = DMA1_LIFCR_CFEIF1_Values<DMA1::LIFCR, 6, 1, ReadWriteMode, DMA1LIFCRBase> ;
    using CTCIF0 = DMA1_LIFCR_CTCIF0_Values<DMA1::LIFCR, 5, 1, ReadWriteMode, DMA1LIFCRBase> ;
    using CHTIF0 = DMA1_LIFCR_CHTIF0_Values<DMA1::LIFCR, 4, 1, ReadWriteMode, DMA1LIFCRBase> ;
    using CTEIF0 = DMA1_LIFCR_CTEIF0_Values<DMA1::LIFCR, 3, 1, ReadWriteMode, DMA1LIFCRBase> ;
    using CDMEIF0 = DMA1_LIFCR_CDMEIF0_Values<DMA1::LIFCR, 2, 1, ReadWriteMode, DMA1LIFCRBase> ;
    using CFEIF0 = DMA1_LIFCR_CFEIF0_Values<DMA1::LIFCR, 0, 1, ReadWriteMode, DMA1LIFCRBase> ;
    using FieldValues = DMA1_LIFCR_CFEIF0_Values<DMA1::LIFCR, 0, 0, NoAccess, NoAccess> ;
  } ;

  template<typename... T> 
  using LIFCRPack  = Register<0x40026008, 32, ReadWriteMode, DMA1LIFCRBase, T...> ;

  struct DMA1HIFCRBase {} ;

  struct HIFCR : public RegisterBase<0x4002600C, 32, ReadWriteMode>
  {
    using CTCIF7 = DMA1_HIFCR_CTCIF7_Values<DMA1::HIFCR, 27, 1, ReadWriteMode, DMA1HIFCRBase> ;
    using CHTIF7 = DMA1_HIFCR_CHTIF7_Values<DMA1::HIFCR, 26, 1, ReadWriteMode, DMA1HIFCRBase> ;
    using CTEIF7 = DMA1_HIFCR_CTEIF7_Values<DMA1::HIFCR, 25, 1, ReadWriteMode, DMA1HIFCRBase> ;
    using CDMEIF7 = DMA1_HIFCR_CDMEIF7_Values<DMA1::HIFCR, 24, 1, ReadWriteMode, DMA1HIFCRBase> ;
    using CFEIF7 = DMA1_HIFCR_CFEIF7_Values<DMA1::HIFCR, 22, 1, ReadWriteMode, DMA1HIFCRBase> ;
    using CTCIF6 = DMA1_HIFCR_CTCIF6_Values<DMA1::HIFCR, 21, 1, ReadWriteMode, DMA1HIFCRBase> ;
    using CHTIF6 = DMA1_HIFCR_CHTIF6_Values<DMA1::HIFCR, 20, 1, ReadWriteMode, DMA1HIFCRBase> ;
    using CTEIF6 = DMA1_HIFCR_CTEIF6_Values<DMA1::HIFCR, 19, 1, ReadWriteMode, DMA1HIFCRBase> ;
    using CDMEIF6 = DMA1_HIFCR_CDMEIF6_Values<DMA1::HIFCR, 18, 1, ReadWriteMode, DMA1HIFCRBase> ;
    using CFEIF6 = DMA1_HIFCR_CFEIF6_Values<DMA1::HIFCR, 16, 1, ReadWriteMode, DMA1HIFCRBase> ;
    using CTCIF5 = DMA1_HIFCR_CTCIF5_Values<DMA1::HIFCR, 11, 1, ReadWriteMode, DMA1HIFCRBase> ;
    using CHTIF5 = DMA1_HIFCR_CHTIF5_Values<DMA1::HIFCR, 10, 1, ReadWriteMode, DMA1HIFCRBase> ;
    using CTEIF5 = DMA1_HIFCR_CTEIF5_Values<DMA1::HIFCR, 9, 1, ReadWriteMode, DMA1HIFCRBase> ;
    using CDMEIF5 = DMA1_HIFCR_CDMEIF5_Values<DMA1::HIFCR, 8, 1, ReadWriteMode, DMA1HIFCRBase> ;
    using CFEIF5 = DMA1_HIFCR_CFEIF5_Values<DMA1::HIFCR, 6, 1, ReadWriteMode, DMA1HIFCRBase> ;
    using CTCIF4 = DMA1_HIFCR_CTCIF4_Values<DMA1::HIFCR, 5, 1, ReadWriteMode, DMA1HIFCRBase> ;
    using CHTIF4 = DMA1_HIFCR_CHTIF4_Values<DMA1::HIFCR, 4, 1, ReadWriteMode, DMA1HIFCRBase> ;
    using CTEIF4 = DMA1_HIFCR_CTEIF4_Values<DMA1::HIFCR, 3, 1, ReadWriteMode, DMA1HIFCRBase> ;
    using CDMEIF4 = DMA1_HIFCR_CDMEIF4_Values<DMA1::HIFCR, 2, 1, ReadWriteMode, DMA1HIFCRBase> ;
    using CFEIF4 = DMA1_HIFCR_CFEIF4_Values<DMA1::HIFCR, 0, 1, ReadWriteMode, DMA1HIFCRBase> ;
    using FieldValues = DMA1_HIFCR_CFEIF4_Values<DMA1::HIFCR, 0, 0, NoAccess, NoAccess> ;
  } ;

  template<typename... T> 
  using HIFCRPack  = Register<0x4002600C, 32, ReadWriteMode, DMA1HIFCRBase, T...> ;
