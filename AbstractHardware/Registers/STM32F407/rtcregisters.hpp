...
struct RTC
{
  ...
  {
    using ALARMOUTTYPE = RTC_TSTR_ALARMOUTTYPE_Values<RTC::TSTR, 18, 1, ReadMode, RTCTSTRBase> ;
    using TSINSEL = RTC_TSTR_TSINSEL_Values<RTC::TSTR, 17, 1, ReadMode, RTCTSTRBase> ;
    using TAMP1INSEL = RTC_TSTR_TAMP1INSEL_Values<RTC::TSTR, 16, 1, ReadMode, RTCTSTRBase> ;
    using TAMPIE = RTC_TSTR_TAMPIE_Values<RTC::TSTR, 2, 1, ReadMode, RTCTSTRBase> ;
    using TAMP1TRG = RTC_TSTR_TAMP1TRG_Values<RTC::TSTR, 1, 1, ReadMode, RTCTSTRBase> ;
    using TAMP1E = RTC_TSTR_TAMP1E_Values<RTC::TSTR, 0, 1, ReadMode, RTCTSTRBase> ;
    using FieldValues = RTC_TSTR_TAMP1E_Values<RTC::TSTR, 0, 0, NoAccess, NoAccess> ;
  } ;
