...
struct RCC
{
  ...
  {
    using OTGHSRST = RCC_AHB1RSTR_OTGHSRST_Values<RCC::AHB1RSTR, 29, 1, ReadWriteMode, RCCAHB1RSTRBase> ;
    using ETHMACRST = RCC_AHB1RSTR_ETHMACRST_Values<RCC::AHB1RSTR, 25, 1, ReadWriteMode, RCCAHB1RSTRBase> ;
    ...
    using GPIOIRST = RCC_AHB1RSTR_GPIOIRST_Values<RCC::AHB1RSTR, 8, 1, ReadWriteMode, RCCAHB1RSTRBase> ;
    using GPIOHRST = RCC_AHB1RSTR_GPIOHRST_Values<RCC::AHB1RSTR, 7, 1, ReadWriteMode, RCCAHB1RSTRBase> ;
    using GPIOGRST = RCC_AHB1RSTR_GPIOGRST_Values<RCC::AHB1RSTR, 6, 1, ReadWriteMode, RCCAHB1RSTRBase> ;
    using GPIOFRST = RCC_AHB1RSTR_GPIOFRST_Values<RCC::AHB1RSTR, 5, 1, ReadWriteMode, RCCAHB1RSTRBase> ;
  ...
  struct AHB2RSTR : public RegisterBase<0x40023814, 32, ReadWriteMode>
  {
    ...
    using DCMIRST = RCC_AHB2RSTR_DCMIRST_Values<RCC::AHB2RSTR, 0, 1, ReadWriteMode, RCCAHB2RSTRBase> ;
    using FieldValues = RCC_AHB2RSTR_DCMIRST_Values<RCC::AHB2RSTR, 0, 0, NoAccess, NoAccess> ;
  } ;
  ...
  struct AHB3RSTR : public RegisterBase<0x40023818, 32, ReadWriteMode>
  {
    using FSMCRST = RCC_AHB3RSTR_FSMCRST_Values<RCC::AHB3RSTR, 0, 1, ReadWriteMode, RCCAHB3RSTRBase> ;
    using FieldValues = RCC_AHB3RSTR_FSMCRST_Values<RCC::AHB3RSTR, 0, 0, NoAccess, NoAccess> ;
  } ;

  template<typename... T> 
  using AHB3RSTRPack  = Register<0x40023818, 32, ReadWriteMode, RCCAHB3RSTRBase, T...> ;
  ...
  struct APB1RSTR : public RegisterBase<0x40023820, 32, ReadWriteMode>
  {
    ...
    using CAN2RST = RCC_APB1RSTR_CAN2RST_Values<RCC::APB1RSTR, 26, 1, ReadWriteMode, RCCAPB1RSTRBase> ;
    using CAN1RST = RCC_APB1RSTR_CAN1RST_Values<RCC::APB1RSTR, 25, 1, ReadWriteMode, RCCAPB1RSTRBase> ;
    ...
    using UART3RST = RCC_APB1RSTR_UART3RST_Values<RCC::APB1RSTR, 18, 1, ReadWriteMode, RCCAPB1RSTRBase> ;
  ...
  {
    using OTGHSULPIEN = RCC_AHB1ENR_OTGHSULPIEN_Values<RCC::AHB1ENR, 30, 1, ReadWriteMode, RCCAHB1ENRBase> ;
    using OTGHSEN = RCC_AHB1ENR_OTGHSEN_Values<RCC::AHB1ENR, 29, 1, ReadWriteMode, RCCAHB1ENRBase> ;
    using ETHMACPTPEN = RCC_AHB1ENR_ETHMACPTPEN_Values<RCC::AHB1ENR, 28, 1, ReadWriteMode, RCCAHB1ENRBase> ;
    using ETHMACRXEN = RCC_AHB1ENR_ETHMACRXEN_Values<RCC::AHB1ENR, 27, 1, ReadWriteMode, RCCAHB1ENRBase> ;
    using ETHMACTXEN = RCC_AHB1ENR_ETHMACTXEN_Values<RCC::AHB1ENR, 26, 1, ReadWriteMode, RCCAHB1ENRBase> ;
    using ETHMACEN = RCC_AHB1ENR_ETHMACEN_Values<RCC::AHB1ENR, 25, 1, ReadWriteMode, RCCAHB1ENRBase> ;
    ...
    using BKPSRAMEN = RCC_AHB1ENR_BKPSRAMEN_Values<RCC::AHB1ENR, 18, 1, ReadWriteMode, RCCAHB1ENRBase> ;
    using CRCEN = RCC_AHB1ENR_CRCEN_Values<RCC::AHB1ENR, 12, 1, ReadWriteMode, RCCAHB1ENRBase> ;
    using GPIOIEN = RCC_AHB1ENR_GPIOIEN_Values<RCC::AHB1ENR, 8, 1, ReadWriteMode, RCCAHB1ENRBase> ;
    using GPIOHEN = RCC_AHB1ENR_GPIOHEN_Values<RCC::AHB1ENR, 7, 1, ReadWriteMode, RCCAHB1ENRBase> ;
    using GPIOGEN = RCC_AHB1ENR_GPIOGEN_Values<RCC::AHB1ENR, 6, 1, ReadWriteMode, RCCAHB1ENRBase> ;
    using GPIOFEN = RCC_AHB1ENR_GPIOFEN_Values<RCC::AHB1ENR, 5, 1, ReadWriteMode, RCCAHB1ENRBase> ;
  ...
  struct AHB2ENR : public RegisterBase<0x40023834, 32, ReadWriteMode>
  {
    ...
    using DCMIEN = RCC_AHB2ENR_DCMIEN_Values<RCC::AHB2ENR, 0, 1, ReadWriteMode, RCCAHB2ENRBase> ;
    using FieldValues = RCC_AHB2ENR_DCMIEN_Values<RCC::AHB2ENR, 0, 0, NoAccess, NoAccess> ;
  } ;
  ...
  struct AHB3ENR : public RegisterBase<0x40023838, 32, ReadWriteMode>
  {
    using FSMCEN = RCC_AHB3ENR_FSMCEN_Values<RCC::AHB3ENR, 0, 1, ReadWriteMode, RCCAHB3ENRBase> ;
    using FieldValues = RCC_AHB3ENR_FSMCEN_Values<RCC::AHB3ENR, 0, 0, NoAccess, NoAccess> ;
  } ;

  template<typename... T> 
  using AHB3ENRPack  = Register<0x40023838, 32, ReadWriteMode, RCCAHB3ENRBase, T...> ;
  ...
  struct APB1ENR : public RegisterBase<0x40023840, 32, ReadWriteMode>
  {
    ...
    using CAN2EN = RCC_APB1ENR_CAN2EN_Values<RCC::APB1ENR, 26, 1, ReadWriteMode, RCCAPB1ENRBase> ;
    using CAN1EN = RCC_APB1ENR_CAN1EN_Values<RCC::APB1ENR, 25, 1, ReadWriteMode, RCCAPB1ENRBase> ;
  ...
  struct APB2ENR : public RegisterBase<0x40023844, 32, ReadWriteMode>
  {
    ...
    using ADC3EN = RCC_APB2ENR_ADC3EN_Values<RCC::APB2ENR, 10, 1, ReadWriteMode, RCCAPB2ENRBase> ;
    using ADC2EN = RCC_APB2ENR_ADC2EN_Values<RCC::APB2ENR, 9, 1, ReadWriteMode, RCCAPB2ENRBase> ;
  ...
  {
    using OTGHSULPILPEN = RCC_AHB1LPENR_OTGHSULPILPEN_Values<RCC::AHB1LPENR, 30, 1, ReadWriteMode, RCCAHB1LPENRBase> ;
    using OTGHSLPEN = RCC_AHB1LPENR_OTGHSLPEN_Values<RCC::AHB1LPENR, 29, 1, ReadWriteMode, RCCAHB1LPENRBase> ;
    using ETHMACPTPLPEN = RCC_AHB1LPENR_ETHMACPTPLPEN_Values<RCC::AHB1LPENR, 28, 1, ReadWriteMode, RCCAHB1LPENRBase> ;
    using ETHMACRXLPEN = RCC_AHB1LPENR_ETHMACRXLPEN_Values<RCC::AHB1LPENR, 27, 1, ReadWriteMode, RCCAHB1LPENRBase> ;
    using ETHMACTXLPEN = RCC_AHB1LPENR_ETHMACTXLPEN_Values<RCC::AHB1LPENR, 26, 1, ReadWriteMode, RCCAHB1LPENRBase> ;
    using ETHMACLPEN = RCC_AHB1LPENR_ETHMACLPEN_Values<RCC::AHB1LPENR, 25, 1, ReadWriteMode, RCCAHB1LPENRBase> ;
    ...
    using BKPSRAMLPEN = RCC_AHB1LPENR_BKPSRAMLPEN_Values<RCC::AHB1LPENR, 18, 1, ReadWriteMode, RCCAHB1LPENRBase> ;
    using SRAM2LPEN = RCC_AHB1LPENR_SRAM2LPEN_Values<RCC::AHB1LPENR, 17, 1, ReadWriteMode, RCCAHB1LPENRBase> ;
    ...
    using GPIOILPEN = RCC_AHB1LPENR_GPIOILPEN_Values<RCC::AHB1LPENR, 8, 1, ReadWriteMode, RCCAHB1LPENRBase> ;
    using GPIOHLPEN = RCC_AHB1LPENR_GPIOHLPEN_Values<RCC::AHB1LPENR, 7, 1, ReadWriteMode, RCCAHB1LPENRBase> ;
    using GPIOGLPEN = RCC_AHB1LPENR_GPIOGLPEN_Values<RCC::AHB1LPENR, 6, 1, ReadWriteMode, RCCAHB1LPENRBase> ;
    using GPIOFLPEN = RCC_AHB1LPENR_GPIOFLPEN_Values<RCC::AHB1LPENR, 5, 1, ReadWriteMode, RCCAHB1LPENRBase> ;
  ...
  struct AHB2LPENR : public RegisterBase<0x40023854, 32, ReadWriteMode>
  {
    ...
    using DCMILPEN = RCC_AHB2LPENR_DCMILPEN_Values<RCC::AHB2LPENR, 0, 1, ReadWriteMode, RCCAHB2LPENRBase> ;
    using FieldValues = RCC_AHB2LPENR_DCMILPEN_Values<RCC::AHB2LPENR, 0, 0, NoAccess, NoAccess> ;
  } ;
  ...
  struct AHB3LPENR : public RegisterBase<0x40023858, 32, ReadWriteMode>
  {
    using FSMCLPEN = RCC_AHB3LPENR_FSMCLPEN_Values<RCC::AHB3LPENR, 0, 1, ReadWriteMode, RCCAHB3LPENRBase> ;
    using FieldValues = RCC_AHB3LPENR_FSMCLPEN_Values<RCC::AHB3LPENR, 0, 0, NoAccess, NoAccess> ;
  } ;

  template<typename... T> 
  using AHB3LPENRPack  = Register<0x40023858, 32, ReadWriteMode, RCCAHB3LPENRBase, T...> ;

  struct RCCAPB1LPENRBase {} ;

  struct APB1LPENR : public RegisterBase<0x40023860, 32, ReadWriteMode>
  {
    using DACLPEN = RCC_APB1LPENR_DACLPEN_Values<RCC::APB1LPENR, 29, 1, ReadWriteMode, RCCAPB1LPENRBase> ;
    using PWRLPEN = RCC_APB1LPENR_PWRLPEN_Values<RCC::APB1LPENR, 28, 1, ReadWriteMode, RCCAPB1LPENRBase> ;
    using CAN2LPEN = RCC_APB1LPENR_CAN2LPEN_Values<RCC::APB1LPENR, 26, 1, ReadWriteMode, RCCAPB1LPENRBase> ;
    using CAN1LPEN = RCC_APB1LPENR_CAN1LPEN_Values<RCC::APB1LPENR, 25, 1, ReadWriteMode, RCCAPB1LPENRBase> ;
    ...
    using UART5LPEN = RCC_APB1LPENR_UART5LPEN_Values<RCC::APB1LPENR, 20, 1, ReadWriteMode, RCCAPB1LPENRBase> ;
    using UART4LPEN = RCC_APB1LPENR_UART4LPEN_Values<RCC::APB1LPENR, 19, 1, ReadWriteMode, RCCAPB1LPENRBase> ;
    using USART3LPEN = RCC_APB1LPENR_USART3LPEN_Values<RCC::APB1LPENR, 18, 1, ReadWriteMode, RCCAPB1LPENRBase> ;
    ...
    using TIM14LPEN = RCC_APB1LPENR_TIM14LPEN_Values<RCC::APB1LPENR, 8, 1, ReadWriteMode, RCCAPB1LPENRBase> ;
    using TIM13LPEN = RCC_APB1LPENR_TIM13LPEN_Values<RCC::APB1LPENR, 7, 1, ReadWriteMode, RCCAPB1LPENRBase> ;
    using TIM12LPEN = RCC_APB1LPENR_TIM12LPEN_Values<RCC::APB1LPENR, 6, 1, ReadWriteMode, RCCAPB1LPENRBase> ;
    using TIM7LPEN = RCC_APB1LPENR_TIM7LPEN_Values<RCC::APB1LPENR, 5, 1, ReadWriteMode, RCCAPB1LPENRBase> ;
    using TIM6LPEN = RCC_APB1LPENR_TIM6LPEN_Values<RCC::APB1LPENR, 4, 1, ReadWriteMode, RCCAPB1LPENRBase> ;
  ...
  struct APB2LPENR : public RegisterBase<0x40023864, 32, ReadWriteMode>
  {
    ...
    using ADC3LPEN = RCC_APB2LPENR_ADC3LPEN_Values<RCC::APB2LPENR, 10, 1, ReadWriteMode, RCCAPB2LPENRBase> ;
    using ADC2LPEN = RCC_APB2LPENR_ADC2LPEN_Values<RCC::APB2LPENR, 9, 1, ReadWriteMode, RCCAPB2LPENRBase> ;
    ...
    using FieldValues = RCC_APB2LPENR_TIM1LPEN_Values<RCC::APB2LPENR, 0, 0, NoAccess, NoAccess> ;
  } ;
