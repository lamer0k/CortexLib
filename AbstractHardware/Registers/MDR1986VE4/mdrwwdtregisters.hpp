...
struct MDR_WWDT
{
  ...
  struct CR : public RegisterBase<0x40048000, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using CRPack  = Register<0x40048000, 32, ReadWriteMode, MDR_WWDTCRBase, T...> ;

  struct MDR_WWDTCFRBase {} ;

  struct CFR : public RegisterBase<0x40048004, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using CFRPack  = Register<0x40048004, 32, ReadWriteMode, MDR_WWDTCFRBase, T...> ;

  struct MDR_WWDTSRBase {} ;

  struct SR : public RegisterBase<0x40048008, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using SRPack  = Register<0x40048008, 32, ReadWriteMode, MDR_WWDTSRBase, T...> ;
