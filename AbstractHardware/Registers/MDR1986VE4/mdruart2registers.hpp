...
struct MDR_UART2
{
  ...
  struct DR : public RegisterBase<0x40010000, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using DRPack  = Register<0x40010000, 32, ReadWriteMode, MDR_UART2DRBase, T...> ;

  struct MDR_UART2RSR_ECRBase {} ;

  struct RSR_ECR : public RegisterBase<0x40010004, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using RSR_ECRPack  = Register<0x40010004, 32, ReadWriteMode, MDR_UART2RSR_ECRBase, T...> ;

  struct MDR_UART2FRBase {} ;

  struct FR : public RegisterBase<0x40010018, 32, ReadMode>
  {
  ...
  template<typename... T> 
  using FRPack  = Register<0x40010018, 32, ReadMode, MDR_UART2FRBase, T...> ;

  struct MDR_UART2ILPRBase {} ;

  struct ILPR : public RegisterBase<0x40010020, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using ILPRPack  = Register<0x40010020, 32, ReadWriteMode, MDR_UART2ILPRBase, T...> ;

  struct MDR_UART2IBRDBase {} ;

  struct IBRD : public RegisterBase<0x40010024, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using IBRDPack  = Register<0x40010024, 32, ReadWriteMode, MDR_UART2IBRDBase, T...> ;

  struct MDR_UART2FBRDBase {} ;

  struct FBRD : public RegisterBase<0x40010028, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using FBRDPack  = Register<0x40010028, 32, ReadWriteMode, MDR_UART2FBRDBase, T...> ;

  struct MDR_UART2LCR_HBase {} ;

  struct LCR_H : public RegisterBase<0x4001002C, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using LCR_HPack  = Register<0x4001002C, 32, ReadWriteMode, MDR_UART2LCR_HBase, T...> ;

  struct MDR_UART2CRBase {} ;

  struct CR : public RegisterBase<0x40010030, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using CRPack  = Register<0x40010030, 32, ReadWriteMode, MDR_UART2CRBase, T...> ;

  struct MDR_UART2IFLSBase {} ;

  struct IFLS : public RegisterBase<0x40010034, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using IFLSPack  = Register<0x40010034, 32, ReadWriteMode, MDR_UART2IFLSBase, T...> ;

  struct MDR_UART2IMSCBase {} ;

  struct IMSC : public RegisterBase<0x40010038, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using IMSCPack  = Register<0x40010038, 32, ReadWriteMode, MDR_UART2IMSCBase, T...> ;

  struct MDR_UART2RISBase {} ;

  struct RIS : public RegisterBase<0x4001003C, 32, ReadMode>
  {
  ...
  template<typename... T> 
  using RISPack  = Register<0x4001003C, 32, ReadMode, MDR_UART2RISBase, T...> ;

  struct MDR_UART2MISBase {} ;

  struct MIS : public RegisterBase<0x40010040, 32, ReadMode>
  {
  ...
  template<typename... T> 
  using MISPack  = Register<0x40010040, 32, ReadMode, MDR_UART2MISBase, T...> ;

  struct MDR_UART2ICRBase {} ;

  struct ICR : public RegisterBase<0x40010044, 32, WriteMode>
  {
  ...
  template<typename... T> 
  using ICRPack  = Register<0x40010044, 32, WriteMode, MDR_UART2ICRBase, T...> ;

  struct MDR_UART2DMACRBase {} ;

  struct DMACR : public RegisterBase<0x40010048, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using DMACRPack  = Register<0x40010048, 32, ReadWriteMode, MDR_UART2DMACRBase, T...> ;

  struct MDR_UART2TCRBase {} ;

  struct TCR : public RegisterBase<0x40010080, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using TCRPack  = Register<0x40010080, 32, ReadWriteMode, MDR_UART2TCRBase, T...> ;
