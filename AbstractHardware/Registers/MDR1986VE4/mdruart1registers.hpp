...
struct MDR_UART1
{
  ...
  struct DR : public RegisterBase<0x40008000, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using DRPack  = Register<0x40008000, 32, ReadWriteMode, MDR_UART1DRBase, T...> ;

  struct MDR_UART1RSR_ECRBase {} ;

  struct RSR_ECR : public RegisterBase<0x40008004, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using RSR_ECRPack  = Register<0x40008004, 32, ReadWriteMode, MDR_UART1RSR_ECRBase, T...> ;

  struct MDR_UART1FRBase {} ;

  struct FR : public RegisterBase<0x40008018, 32, ReadMode>
  {
  ...
  template<typename... T> 
  using FRPack  = Register<0x40008018, 32, ReadMode, MDR_UART1FRBase, T...> ;

  struct MDR_UART1ILPRBase {} ;

  struct ILPR : public RegisterBase<0x40008020, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using ILPRPack  = Register<0x40008020, 32, ReadWriteMode, MDR_UART1ILPRBase, T...> ;

  struct MDR_UART1IBRDBase {} ;

  struct IBRD : public RegisterBase<0x40008024, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using IBRDPack  = Register<0x40008024, 32, ReadWriteMode, MDR_UART1IBRDBase, T...> ;

  struct MDR_UART1FBRDBase {} ;

  struct FBRD : public RegisterBase<0x40008028, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using FBRDPack  = Register<0x40008028, 32, ReadWriteMode, MDR_UART1FBRDBase, T...> ;

  struct MDR_UART1LCR_HBase {} ;

  struct LCR_H : public RegisterBase<0x4000802C, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using LCR_HPack  = Register<0x4000802C, 32, ReadWriteMode, MDR_UART1LCR_HBase, T...> ;

  struct MDR_UART1CRBase {} ;

  struct CR : public RegisterBase<0x40008030, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using CRPack  = Register<0x40008030, 32, ReadWriteMode, MDR_UART1CRBase, T...> ;

  struct MDR_UART1IFLSBase {} ;

  struct IFLS : public RegisterBase<0x40008034, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using IFLSPack  = Register<0x40008034, 32, ReadWriteMode, MDR_UART1IFLSBase, T...> ;

  struct MDR_UART1IMSCBase {} ;

  struct IMSC : public RegisterBase<0x40008038, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using IMSCPack  = Register<0x40008038, 32, ReadWriteMode, MDR_UART1IMSCBase, T...> ;

  struct MDR_UART1RISBase {} ;

  struct RIS : public RegisterBase<0x4000803C, 32, ReadMode>
  {
  ...
  template<typename... T> 
  using RISPack  = Register<0x4000803C, 32, ReadMode, MDR_UART1RISBase, T...> ;

  struct MDR_UART1MISBase {} ;

  struct MIS : public RegisterBase<0x40008040, 32, ReadMode>
  {
  ...
  template<typename... T> 
  using MISPack  = Register<0x40008040, 32, ReadMode, MDR_UART1MISBase, T...> ;

  struct MDR_UART1ICRBase {} ;

  struct ICR : public RegisterBase<0x40008044, 32, WriteMode>
  {
  ...
  template<typename... T> 
  using ICRPack  = Register<0x40008044, 32, WriteMode, MDR_UART1ICRBase, T...> ;

  struct MDR_UART1DMACRBase {} ;

  struct DMACR : public RegisterBase<0x40008048, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using DMACRPack  = Register<0x40008048, 32, ReadWriteMode, MDR_UART1DMACRBase, T...> ;

  struct MDR_UART1TCRBase {} ;

  struct TCR : public RegisterBase<0x40008080, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using TCRPack  = Register<0x40008080, 32, ReadWriteMode, MDR_UART1TCRBase, T...> ;
