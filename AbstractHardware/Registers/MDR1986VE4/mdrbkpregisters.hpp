...
struct MDR_BKP
{
  ...
  struct REG_0E : public RegisterBase<0x40060038, 32, ReadWriteMode>
  {
    ...
    using Trim_DUcc = MDR_BKP_REG_0E_Trim_DUcc_Values<MDR_BKP::REG_0E, 12, 2, ReadWriteMode, MDR_BKPREG_0EBase> ;
    using COVDET = MDR_BKP_REG_0E_COVDET_Values<MDR_BKP::REG_0E, 14, 1, ReadWriteMode, MDR_BKPREG_0EBase> ;
    using I_LimEn = MDR_BKP_REG_0E_I_LimEn_Values<MDR_BKP::REG_0E, 15, 1, ReadWriteMode, MDR_BKPREG_0EBase> ;
    using FieldValues = MDR_BKP_REG_0E_I_LimEn_Values<MDR_BKP::REG_0E, 0, 0, NoAccess, NoAccess> ;
  } ;

  template<typename... T> 
  using REG_0EPack  = Register<0x40060038, 32, ReadWriteMode, MDR_BKPREG_0EBase, T...> ;

  struct MDR_BKPREG_0FBase {} ;

  struct REG_0F : public RegisterBase<0x4006003C, 32, ReadWriteMode>
  {
    ...
    using LSI_RDY = MDR_BKP_REG_0F_LSI_RDY_Values<MDR_BKP::REG_0F, 21, 1, ReadMode, MDR_BKPREG_0FBase> ;
  ...
  template<typename... T> 
  using REG_0FPack  = Register<0x4006003C, 32, ReadWriteMode, MDR_BKPREG_0FBase, T...> ;

  struct MDR_BKPRTC_CNTBase {} ;

  struct RTC_CNT : public RegisterBase<0x40060040, 32, ReadWriteMode>
  {
  } ;

  template<typename... T> 
  using RTC_CNTPack  = Register<0x40060040, 32, ReadWriteMode, MDR_BKPRTC_CNTBase, T...> ;

  struct MDR_BKPRTC_DIVBase {} ;

  struct RTC_DIV : public RegisterBase<0x40060044, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using RTC_DIVPack  = Register<0x40060044, 32, ReadWriteMode, MDR_BKPRTC_DIVBase, T...> ;

  struct MDR_BKPRTC_PRLBase {} ;

  struct RTC_PRL : public RegisterBase<0x40060048, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using RTC_PRLPack  = Register<0x40060048, 32, ReadWriteMode, MDR_BKPRTC_PRLBase, T...> ;

  struct MDR_BKPRTC_ALRMBase {} ;

  struct RTC_ALRM : public RegisterBase<0x4006004C, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using RTC_ALRMPack  = Register<0x4006004C, 32, ReadWriteMode, MDR_BKPRTC_ALRMBase, T...> ;

  struct MDR_BKPRTC_CSBase {} ;

  struct RTC_CS : public RegisterBase<0x40060050, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using RTC_CSPack  = Register<0x40060050, 32, ReadWriteMode, MDR_BKPRTC_CSBase, T...> ;

  struct MDR_BKPREG_00Base {} ;

  struct REG_00 : public RegisterBase<0x40060000, 32, ReadWriteMode>
  {
  } ;

  template<typename... T> 
  using REG_00Pack  = Register<0x40060000, 32, ReadWriteMode, MDR_BKPREG_00Base, T...> ;

  struct MDR_BKPREG_01Base {} ;

  struct REG_01 : public RegisterBase<0x40060004, 32, ReadWriteMode>
  {
  } ;

  template<typename... T> 
  using REG_01Pack  = Register<0x40060004, 32, ReadWriteMode, MDR_BKPREG_01Base, T...> ;

  struct MDR_BKPREG_02Base {} ;

  struct REG_02 : public RegisterBase<0x40060008, 32, ReadWriteMode>
  {
  } ;

  template<typename... T> 
  using REG_02Pack  = Register<0x40060008, 32, ReadWriteMode, MDR_BKPREG_02Base, T...> ;

  struct MDR_BKPREG_03Base {} ;

  struct REG_03 : public RegisterBase<0x4006000C, 32, ReadWriteMode>
  {
  } ;

  template<typename... T> 
  using REG_03Pack  = Register<0x4006000C, 32, ReadWriteMode, MDR_BKPREG_03Base, T...> ;

  struct MDR_BKPREG_04Base {} ;

  struct REG_04 : public RegisterBase<0x40060010, 32, ReadWriteMode>
  {
  } ;

  template<typename... T> 
  using REG_04Pack  = Register<0x40060010, 32, ReadWriteMode, MDR_BKPREG_04Base, T...> ;

  struct MDR_BKPREG_05Base {} ;

  struct REG_05 : public RegisterBase<0x40060014, 32, ReadWriteMode>
  {
  } ;

  template<typename... T> 
  using REG_05Pack  = Register<0x40060014, 32, ReadWriteMode, MDR_BKPREG_05Base, T...> ;

  struct MDR_BKPREG_06Base {} ;

  struct REG_06 : public RegisterBase<0x40060018, 32, ReadWriteMode>
  {
  } ;

  template<typename... T> 
  using REG_06Pack  = Register<0x40060018, 32, ReadWriteMode, MDR_BKPREG_06Base, T...> ;

  struct MDR_BKPREG_07Base {} ;

  struct REG_07 : public RegisterBase<0x4006001C, 32, ReadWriteMode>
  {
  } ;

  template<typename... T> 
  using REG_07Pack  = Register<0x4006001C, 32, ReadWriteMode, MDR_BKPREG_07Base, T...> ;

  struct MDR_BKPREG_08Base {} ;

  struct REG_08 : public RegisterBase<0x40060020, 32, ReadWriteMode>
  {
  } ;

  template<typename... T> 
  using REG_08Pack  = Register<0x40060020, 32, ReadWriteMode, MDR_BKPREG_08Base, T...> ;

  struct MDR_BKPREG_09Base {} ;

  struct REG_09 : public RegisterBase<0x40060024, 32, ReadWriteMode>
  {
  } ;

  template<typename... T> 
  using REG_09Pack  = Register<0x40060024, 32, ReadWriteMode, MDR_BKPREG_09Base, T...> ;

  struct MDR_BKPREG_0ABase {} ;

  struct REG_0A : public RegisterBase<0x40060028, 32, ReadWriteMode>
  {
  } ;

  template<typename... T> 
  using REG_0APack  = Register<0x40060028, 32, ReadWriteMode, MDR_BKPREG_0ABase, T...> ;

  struct MDR_BKPREG_0BBase {} ;

  struct REG_0B : public RegisterBase<0x4006002C, 32, ReadWriteMode>
  {
  } ;

  template<typename... T> 
  using REG_0BPack  = Register<0x4006002C, 32, ReadWriteMode, MDR_BKPREG_0BBase, T...> ;

  struct MDR_BKPREG_0CBase {} ;

  struct REG_0C : public RegisterBase<0x40060030, 32, ReadWriteMode>
  {
  } ;

  template<typename... T> 
  using REG_0CPack  = Register<0x40060030, 32, ReadWriteMode, MDR_BKPREG_0CBase, T...> ;

  struct MDR_BKPREG_0DBase {} ;

  struct REG_0D : public RegisterBase<0x40060034, 32, ReadWriteMode>
  {
  } ;

  template<typename... T> 
  using REG_0DPack  = Register<0x40060034, 32, ReadWriteMode, MDR_BKPREG_0DBase, T...> ;
