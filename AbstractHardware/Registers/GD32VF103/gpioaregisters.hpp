...
struct GPIOA
{
  ...
  struct CTL0 : public RegisterBase<0x40010800, 32, ReadWriteMode>
  {
    ...
    using CTLMD7 = GPIOA_CTL_MD_Values<GPIOA::CTL0, 28, 4, ReadWriteMode, GPIOACTL0Base> ;
    using CTLMD6 = GPIOA_CTL_MD_Values<GPIOA::CTL0, 24, 4, ReadWriteMode, GPIOACTL0Base> ;
    using CTLMD5 = GPIOA_CTL_MD_Values<GPIOA::CTL0, 20, 4, ReadWriteMode, GPIOACTL0Base> ;
    using CTLMD4 = GPIOA_CTL_MD_Values<GPIOA::CTL0, 16, 4, ReadWriteMode, GPIOACTL0Base> ;
    using CTLMD3 = GPIOA_CTL_MD_Values<GPIOA::CTL0, 12, 4, ReadWriteMode, GPIOACTL0Base> ;
    using CTLMD2 = GPIOA_CTL_MD_Values<GPIOA::CTL0, 8, 4, ReadWriteMode, GPIOACTL0Base> ;
    using CTLMD1 = GPIOA_CTL_MD_Values<GPIOA::CTL0, 4, 4, ReadWriteMode, GPIOACTL0Base> ;
    using CTLMD0 = GPIOA_CTL_MD_Values<GPIOA::CTL0, 0, 4, ReadWriteMode, GPIOACTL0Base> ;
    using FieldValues = GPIOA_CTL_MD_Values<GPIOA::CTL0, 0, 0, NoAccess, NoAccess> ;
  } ;
  ...
  {
      using CTLMD15 = GPIOA_CTL_MD_Values<GPIOA::CTL0, 28, 4, ReadWriteMode, GPIOACTL0Base> ;
      using CTLMD14 = GPIOA_CTL_MD_Values<GPIOA::CTL0, 24, 4, ReadWriteMode, GPIOACTL0Base> ;
      using CTLMD13 = GPIOA_CTL_MD_Values<GPIOA::CTL0, 20, 4, ReadWriteMode, GPIOACTL0Base> ;
      using CTLMD12 = GPIOA_CTL_MD_Values<GPIOA::CTL0, 16, 4, ReadWriteMode, GPIOACTL0Base> ;
      using CTLMD11 = GPIOA_CTL_MD_Values<GPIOA::CTL0, 12, 4, ReadWriteMode, GPIOACTL0Base> ;
      using CTLMD10 = GPIOA_CTL_MD_Values<GPIOA::CTL0, 8, 4, ReadWriteMode, GPIOACTL0Base> ;
      using CTLMD9 = GPIOA_CTL_MD_Values<GPIOA::CTL0, 4, 4, ReadWriteMode, GPIOACTL0Base> ;
      using CTLMD8 = GPIOA_CTL_MD_Values<GPIOA::CTL0, 0, 4, ReadWriteMode, GPIOACTL0Base> ;
      using FieldValues = GPIOA_CTL_MD_Values<GPIOA::CTL0, 0, 0, NoAccess, NoAccess> ;
  } ;
