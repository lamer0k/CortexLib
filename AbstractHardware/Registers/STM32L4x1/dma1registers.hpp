...
struct DMA1
{
  ...
  struct DMA1CSELRBase {} ;

  struct CSELR : public RegisterBase<0x400200A8, 32, ReadWriteMode>
  {
    using C7S = DMA1_CSELR_C7S_Values<DMA1::CSELR, 24, 4, ReadWriteMode, DMA1CSELRBase> ;
    using C6S = DMA1_CSELR_C6S_Values<DMA1::CSELR, 20, 4, ReadWriteMode, DMA1CSELRBase> ;
    using C5S = DMA1_CSELR_C5S_Values<DMA1::CSELR, 16, 4, ReadWriteMode, DMA1CSELRBase> ;
    using C4S = DMA1_CSELR_C4S_Values<DMA1::CSELR, 12, 4, ReadWriteMode, DMA1CSELRBase> ;
    using C3S = DMA1_CSELR_C3S_Values<DMA1::CSELR, 8, 4, ReadWriteMode, DMA1CSELRBase> ;
    using C2S = DMA1_CSELR_C2S_Values<DMA1::CSELR, 4, 4, ReadWriteMode, DMA1CSELRBase> ;
    using C1S = DMA1_CSELR_C1S_Values<DMA1::CSELR, 0, 4, ReadWriteMode, DMA1CSELRBase> ;
    using FieldValues = DMA1_CSELR_C1S_Values<DMA1::CSELR, 0, 0, NoAccess, NoAccess> ;
  } ;

  template<typename... T> 
  using CSELRPack  = Register<0x400200A8, 32, ReadWriteMode, DMA1CSELRBase, T...> ;
