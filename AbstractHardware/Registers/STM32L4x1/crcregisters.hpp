...
struct CRC
{
  ...
  {
    using Polynomialcoefficients = CRC_POL_Polynomialcoefficients_Values<CRC::POL, 0, 32, ReadWriteMode, CRCPOLBase> ;
    using FieldValues = CRC_POL_Polynomialcoefficients_Values<CRC::POL, 0, 0, NoAccess, NoAccess> ;
  } ;
