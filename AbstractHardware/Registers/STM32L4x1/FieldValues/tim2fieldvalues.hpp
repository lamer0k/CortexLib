...
template <typename Reg, size_t offset, size_t size, typename AccessMode, typename BaseType> 
struct TIM2_DIER_COMDE_Values: public RegisterField<Reg, offset, size, AccessMode> 
{
  using Value0 = FieldValue<TIM2_DIER_COMDE_Values, BaseType, 0U> ;
  using Value1 = FieldValue<TIM2_DIER_COMDE_Values, BaseType, 1U> ;
} ;
...
struct TIM2_OR_ETR_RMP_Values: public RegisterField<Reg, offset, size, AccessMode> 
{
  ...
  using Value2 = FieldValue<TIM2_OR_ETR_RMP_Values, BaseType, 2U> ;
  using Value3 = FieldValue<TIM2_OR_ETR_RMP_Values, BaseType, 3U> ;
  using Value4 = FieldValue<TIM2_OR_ETR_RMP_Values, BaseType, 4U> ;
  using Value5 = FieldValue<TIM2_OR_ETR_RMP_Values, BaseType, 5U> ;
  using Value6 = FieldValue<TIM2_OR_ETR_RMP_Values, BaseType, 6U> ;
  using Value7 = FieldValue<TIM2_OR_ETR_RMP_Values, BaseType, 7U> ;
} ;
