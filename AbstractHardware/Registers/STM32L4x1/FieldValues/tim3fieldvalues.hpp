...
template <typename Reg, size_t offset, size_t size, typename AccessMode, typename BaseType> 
struct TIM3_DIER_COMDE_Values: public RegisterField<Reg, offset, size, AccessMode> 
{
  using Value0 = FieldValue<TIM3_DIER_COMDE_Values, BaseType, 0U> ;
  using Value1 = FieldValue<TIM3_DIER_COMDE_Values, BaseType, 1U> ;
} ;
...
template <typename Reg, size_t offset, size_t size, typename AccessMode, typename BaseType> 
struct TIM3_OR_ETR_RMP_Values: public RegisterField<Reg, offset, size, AccessMode> 
{
  using Value0 = FieldValue<TIM3_OR_ETR_RMP_Values, BaseType, 0U> ;
  using Value1 = FieldValue<TIM3_OR_ETR_RMP_Values, BaseType, 1U> ;
  using Value2 = FieldValue<TIM3_OR_ETR_RMP_Values, BaseType, 2U> ;
  using Value3 = FieldValue<TIM3_OR_ETR_RMP_Values, BaseType, 3U> ;
  using Value4 = FieldValue<TIM3_OR_ETR_RMP_Values, BaseType, 4U> ;
  using Value5 = FieldValue<TIM3_OR_ETR_RMP_Values, BaseType, 5U> ;
  using Value6 = FieldValue<TIM3_OR_ETR_RMP_Values, BaseType, 6U> ;
  using Value7 = FieldValue<TIM3_OR_ETR_RMP_Values, BaseType, 7U> ;
} ;

template <typename Reg, size_t offset, size_t size, typename AccessMode, typename BaseType> 
struct TIM3_OR_TI4_RMP_Values: public RegisterField<Reg, offset, size, AccessMode> 
{
  using Value0 = FieldValue<TIM3_OR_TI4_RMP_Values, BaseType, 0U> ;
  using Value1 = FieldValue<TIM3_OR_TI4_RMP_Values, BaseType, 1U> ;
  using Value2 = FieldValue<TIM3_OR_TI4_RMP_Values, BaseType, 2U> ;
  using Value3 = FieldValue<TIM3_OR_TI4_RMP_Values, BaseType, 3U> ;
} ;
