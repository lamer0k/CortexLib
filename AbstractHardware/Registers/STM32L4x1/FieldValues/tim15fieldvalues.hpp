...
template <typename Reg, size_t offset, size_t size, typename AccessMode, typename BaseType> 
struct TIM15_CCMR1_Output_OC1M_2_Values: public RegisterField<Reg, offset, size, AccessMode> 
{
  using Value0 = FieldValue<TIM15_CCMR1_Output_OC1M_2_Values, BaseType, 0U> ;
  using Value1 = FieldValue<TIM15_CCMR1_Output_OC1M_2_Values, BaseType, 1U> ;
} ;
