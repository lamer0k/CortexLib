...
struct TIM16
{
  ...
  struct DIER : public RegisterBase<0x4001440C, 32, ReadWriteMode>
  {
    ...
    using FieldValues = TIM16_DIER_UIE_Values<TIM16::DIER, 0, 0, NoAccess, NoAccess> ;
  } ;
  ...
  {
    using OC1M_2 = TIM16_CCMR1_Output_OC1M_2_Values<TIM16::CCMR1_Output, 16, 1, ReadWriteMode, TIM16CCMR1_OutputBase> ;
  ...
  struct OR2 : public RegisterBase<0x40014460, 32, ReadWriteMode>
  {
    using BKINE = TIM16_OR2_BKINE_Values<TIM16::OR2, 0, 1, ReadWriteMode, TIM16OR2Base> ;
    using BKCMP1E = TIM16_OR2_BKCMP1E_Values<TIM16::OR2, 1, 1, ReadWriteMode, TIM16OR2Base> ;
    using BKCMP2E = TIM16_OR2_BKCMP2E_Values<TIM16::OR2, 2, 1, ReadWriteMode, TIM16OR2Base> ;
    using BKDFBK1E = TIM16_OR2_BKDFBK1E_Values<TIM16::OR2, 8, 1, ReadWriteMode, TIM16OR2Base> ;
    using BKINP = TIM16_OR2_BKINP_Values<TIM16::OR2, 9, 1, ReadWriteMode, TIM16OR2Base> ;
    using BKCMP1P = TIM16_OR2_BKCMP1P_Values<TIM16::OR2, 10, 1, ReadWriteMode, TIM16OR2Base> ;
    using BKCMP2P = TIM16_OR2_BKCMP2P_Values<TIM16::OR2, 11, 1, ReadWriteMode, TIM16OR2Base> ;
    using FieldValues = TIM16_OR2_BKCMP2P_Values<TIM16::OR2, 0, 0, NoAccess, NoAccess> ;
  } ;

  template<typename... T> 
  using OR2Pack  = Register<0x40014460, 32, ReadWriteMode, TIM16OR2Base, T...> ;
