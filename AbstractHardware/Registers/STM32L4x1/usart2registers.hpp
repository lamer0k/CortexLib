...
struct USART2
{
  ...
  struct CR1 : public RegisterBase<0x40004400, 32, ReadWriteMode>
  {
    ...
    using DEAT4 = USART2_CR1_DEAT4_Values<USART2::CR1, 25, 1, ReadWriteMode, USART2CR1Base> ;
    using DEAT3 = USART2_CR1_DEAT3_Values<USART2::CR1, 24, 1, ReadWriteMode, USART2CR1Base> ;
    using DEAT2 = USART2_CR1_DEAT2_Values<USART2::CR1, 23, 1, ReadWriteMode, USART2CR1Base> ;
    using DEAT1 = USART2_CR1_DEAT1_Values<USART2::CR1, 22, 1, ReadWriteMode, USART2CR1Base> ;
    using DEAT0 = USART2_CR1_DEAT0_Values<USART2::CR1, 21, 1, ReadWriteMode, USART2CR1Base> ;
    using DEDT4 = USART2_CR1_DEDT4_Values<USART2::CR1, 20, 1, ReadWriteMode, USART2CR1Base> ;
    using DEDT3 = USART2_CR1_DEDT3_Values<USART2::CR1, 19, 1, ReadWriteMode, USART2CR1Base> ;
    using DEDT2 = USART2_CR1_DEDT2_Values<USART2::CR1, 18, 1, ReadWriteMode, USART2CR1Base> ;
    using DEDT1 = USART2_CR1_DEDT1_Values<USART2::CR1, 17, 1, ReadWriteMode, USART2CR1Base> ;
    using DEDT0 = USART2_CR1_DEDT0_Values<USART2::CR1, 16, 1, ReadWriteMode, USART2CR1Base> ;
    ...
    using M0 = USART2_CR1_M0_Values<USART2::CR1, 12, 1, ReadWriteMode, USART2CR1Base> ;
    ...
    using FieldValues = USART2_CR1_UE_Values<USART2::CR1, 0, 0, NoAccess, NoAccess> ;
  } ;
  ...
  {
    using ADD4_7 = USART2_CR2_ADD4_7_Values<USART2::CR2, 28, 4, ReadWriteMode, USART2CR2Base> ;
    using ADD0_3 = USART2_CR2_ADD0_3_Values<USART2::CR2, 24, 4, ReadWriteMode, USART2CR2Base> ;
    using RTOEN = USART2_CR2_RTOEN_Values<USART2::CR2, 23, 1, ReadWriteMode, USART2CR2Base> ;
    using ABRMOD1 = USART2_CR2_ABRMOD1_Values<USART2::CR2, 22, 1, ReadWriteMode, USART2CR2Base> ;
    using ABRMOD0 = USART2_CR2_ABRMOD0_Values<USART2::CR2, 21, 1, ReadWriteMode, USART2CR2Base> ;
    ...
    using TAINV = USART2_CR2_TAINV_Values<USART2::CR2, 18, 1, ReadWriteMode, USART2CR2Base> ;
  ...
  struct RQR : public RegisterBase<0x40004418, 32, WriteMode>
  {
    using TXFRQ = USART2_RQR_TXFRQ_Values<USART2::RQR, 4, 1, WriteMode, USART2RQRBase> ;
    using RXFRQ = USART2_RQR_RXFRQ_Values<USART2::RQR, 3, 1, WriteMode, USART2RQRBase> ;
    using MMRQ = USART2_RQR_MMRQ_Values<USART2::RQR, 2, 1, WriteMode, USART2RQRBase> ;
    using SBKRQ = USART2_RQR_SBKRQ_Values<USART2::RQR, 1, 1, WriteMode, USART2RQRBase> ;
    using ABRRQ = USART2_RQR_ABRRQ_Values<USART2::RQR, 0, 1, WriteMode, USART2RQRBase> ;
    using FieldValues = USART2_RQR_ABRRQ_Values<USART2::RQR, 0, 0, NoAccess, NoAccess> ;
  } ;

  template<typename... T> 
  using RQRPack  = Register<0x40004418, 32, WriteMode, USART2RQRBase, T...> ;
  ...
  struct ICR : public RegisterBase<0x40004420, 32, WriteMode>
  {
    using WUCF = USART2_ICR_WUCF_Values<USART2::ICR, 20, 1, WriteMode, USART2ICRBase> ;
    using CMCF = USART2_ICR_CMCF_Values<USART2::ICR, 17, 1, WriteMode, USART2ICRBase> ;
    using EOBCF = USART2_ICR_EOBCF_Values<USART2::ICR, 12, 1, WriteMode, USART2ICRBase> ;
    using RTOCF = USART2_ICR_RTOCF_Values<USART2::ICR, 11, 1, WriteMode, USART2ICRBase> ;
    using CTSCF = USART2_ICR_CTSCF_Values<USART2::ICR, 9, 1, WriteMode, USART2ICRBase> ;
    using LBDCF = USART2_ICR_LBDCF_Values<USART2::ICR, 8, 1, WriteMode, USART2ICRBase> ;
    using TCCF = USART2_ICR_TCCF_Values<USART2::ICR, 6, 1, WriteMode, USART2ICRBase> ;
    using IDLECF = USART2_ICR_IDLECF_Values<USART2::ICR, 4, 1, WriteMode, USART2ICRBase> ;
    using ORECF = USART2_ICR_ORECF_Values<USART2::ICR, 3, 1, WriteMode, USART2ICRBase> ;
    using NCF = USART2_ICR_NCF_Values<USART2::ICR, 2, 1, WriteMode, USART2ICRBase> ;
    using FECF = USART2_ICR_FECF_Values<USART2::ICR, 1, 1, WriteMode, USART2ICRBase> ;
    using PECF = USART2_ICR_PECF_Values<USART2::ICR, 0, 1, WriteMode, USART2ICRBase> ;
    using FieldValues = USART2_ICR_PECF_Values<USART2::ICR, 0, 0, NoAccess, NoAccess> ;
  } ;

  template<typename... T> 
  using ICRPack  = Register<0x40004420, 32, WriteMode, USART2ICRBase, T...> ;
