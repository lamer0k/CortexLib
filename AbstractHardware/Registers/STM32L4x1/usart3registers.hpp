...
struct USART3
{
  ...
  {
    using M1 = USART3_CR1_M1_Values<USART3::CR1, 28, 1, ReadWriteMode, USART3CR1Base> ;
    ...
    using DEAT4 = USART3_CR1_DEAT4_Values<USART3::CR1, 25, 1, ReadWriteMode, USART3CR1Base> ;
    using DEAT3 = USART3_CR1_DEAT3_Values<USART3::CR1, 24, 1, ReadWriteMode, USART3CR1Base> ;
    using DEAT2 = USART3_CR1_DEAT2_Values<USART3::CR1, 23, 1, ReadWriteMode, USART3CR1Base> ;
    using DEAT1 = USART3_CR1_DEAT1_Values<USART3::CR1, 22, 1, ReadWriteMode, USART3CR1Base> ;
    using DEAT0 = USART3_CR1_DEAT0_Values<USART3::CR1, 21, 1, ReadWriteMode, USART3CR1Base> ;
    using DEDT4 = USART3_CR1_DEDT4_Values<USART3::CR1, 20, 1, ReadWriteMode, USART3CR1Base> ;
    using DEDT3 = USART3_CR1_DEDT3_Values<USART3::CR1, 19, 1, ReadWriteMode, USART3CR1Base> ;
    using DEDT2 = USART3_CR1_DEDT2_Values<USART3::CR1, 18, 1, ReadWriteMode, USART3CR1Base> ;
    using DEDT1 = USART3_CR1_DEDT1_Values<USART3::CR1, 17, 1, ReadWriteMode, USART3CR1Base> ;
    using DEDT0 = USART3_CR1_DEDT0_Values<USART3::CR1, 16, 1, ReadWriteMode, USART3CR1Base> ;
    ...
    using M0 = USART3_CR1_M0_Values<USART3::CR1, 12, 1, ReadWriteMode, USART3CR1Base> ;
  ...
  {
    using ADD4_7 = USART3_CR2_ADD4_7_Values<USART3::CR2, 28, 4, ReadWriteMode, USART3CR2Base> ;
    using ADD0_3 = USART3_CR2_ADD0_3_Values<USART3::CR2, 24, 4, ReadWriteMode, USART3CR2Base> ;
    using RTOEN = USART3_CR2_RTOEN_Values<USART3::CR2, 23, 1, ReadWriteMode, USART3CR2Base> ;
    using ABRMOD1 = USART3_CR2_ABRMOD1_Values<USART3::CR2, 22, 1, ReadWriteMode, USART3CR2Base> ;
    using ABRMOD0 = USART3_CR2_ABRMOD0_Values<USART3::CR2, 21, 1, ReadWriteMode, USART3CR2Base> ;
    ...
    using TAINV = USART3_CR2_TAINV_Values<USART3::CR2, 18, 1, ReadWriteMode, USART3CR2Base> ;
  ...
  struct CR3 : public RegisterBase<0x40004808, 32, ReadWriteMode>
  {
    ...
    using UCESM = USART3_CR3_UCESM_Values<USART3::CR3, 23, 1, ReadWriteMode, USART3CR3Base> ;
    using TCBGTIE = USART3_CR3_TCBGTIE_Values<USART3::CR3, 24, 1, ReadWriteMode, USART3CR3Base> ;
    using FieldValues = USART3_CR3_TCBGTIE_Values<USART3::CR3, 0, 0, NoAccess, NoAccess> ;
  } ;
  ...
  {
    using BRRField = USART3_BRR_BRR_Values<USART3::BRR, 0, 12, ReadWriteMode, USART3BRRBase> ;
    using FieldValues = USART3_BRR_BRR_Values<USART3::BRR, 0, 0, NoAccess, NoAccess> ;
  } ;
  ...
  struct RQR : public RegisterBase<0x40004818, 32, WriteMode>
  {
    using TXFRQ = USART3_RQR_TXFRQ_Values<USART3::RQR, 4, 1, WriteMode, USART3RQRBase> ;
    using RXFRQ = USART3_RQR_RXFRQ_Values<USART3::RQR, 3, 1, WriteMode, USART3RQRBase> ;
    using MMRQ = USART3_RQR_MMRQ_Values<USART3::RQR, 2, 1, WriteMode, USART3RQRBase> ;
    using SBKRQ = USART3_RQR_SBKRQ_Values<USART3::RQR, 1, 1, WriteMode, USART3RQRBase> ;
    using ABRRQ = USART3_RQR_ABRRQ_Values<USART3::RQR, 0, 1, WriteMode, USART3RQRBase> ;
    using FieldValues = USART3_RQR_ABRRQ_Values<USART3::RQR, 0, 0, NoAccess, NoAccess> ;
  } ;

  template<typename... T> 
  using RQRPack  = Register<0x40004818, 32, WriteMode, USART3RQRBase, T...> ;
  ...
  struct ISR : public RegisterBase<0x4000481C, 32, ReadMode>
  {
    ...
    using TCBGT = USART3_ISR_TCBGT_Values<USART3::ISR, 25, 1, ReadMode, USART3ISRBase> ;
    using FieldValues = USART3_ISR_TCBGT_Values<USART3::ISR, 0, 0, NoAccess, NoAccess> ;
  } ;
  ...
  struct ICR : public RegisterBase<0x40004820, 32, WriteMode>
  {
    using WUCF = USART3_ICR_WUCF_Values<USART3::ICR, 20, 1, WriteMode, USART3ICRBase> ;
    using CMCF = USART3_ICR_CMCF_Values<USART3::ICR, 17, 1, WriteMode, USART3ICRBase> ;
    using EOBCF = USART3_ICR_EOBCF_Values<USART3::ICR, 12, 1, WriteMode, USART3ICRBase> ;
    using RTOCF = USART3_ICR_RTOCF_Values<USART3::ICR, 11, 1, WriteMode, USART3ICRBase> ;
    using CTSCF = USART3_ICR_CTSCF_Values<USART3::ICR, 9, 1, WriteMode, USART3ICRBase> ;
    using LBDCF = USART3_ICR_LBDCF_Values<USART3::ICR, 8, 1, WriteMode, USART3ICRBase> ;
    using TCCF = USART3_ICR_TCCF_Values<USART3::ICR, 6, 1, WriteMode, USART3ICRBase> ;
    using IDLECF = USART3_ICR_IDLECF_Values<USART3::ICR, 4, 1, WriteMode, USART3ICRBase> ;
    using ORECF = USART3_ICR_ORECF_Values<USART3::ICR, 3, 1, WriteMode, USART3ICRBase> ;
    using NCF = USART3_ICR_NCF_Values<USART3::ICR, 2, 1, WriteMode, USART3ICRBase> ;
    using FECF = USART3_ICR_FECF_Values<USART3::ICR, 1, 1, WriteMode, USART3ICRBase> ;
    using PECF = USART3_ICR_PECF_Values<USART3::ICR, 0, 1, WriteMode, USART3ICRBase> ;
    using FieldValues = USART3_ICR_PECF_Values<USART3::ICR, 0, 0, NoAccess, NoAccess> ;
  } ;

  template<typename... T> 
  using ICRPack  = Register<0x40004820, 32, WriteMode, USART3ICRBase, T...> ;
