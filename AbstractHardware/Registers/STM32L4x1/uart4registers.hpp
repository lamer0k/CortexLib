...
struct UART4
{
  ...
  {
    using M1 = UART4_CR1_M1_Values<UART4::CR1, 28, 1, ReadWriteMode, UART4CR1Base> ;
    ...
    using DEAT4 = UART4_CR1_DEAT4_Values<UART4::CR1, 25, 1, ReadWriteMode, UART4CR1Base> ;
    using DEAT3 = UART4_CR1_DEAT3_Values<UART4::CR1, 24, 1, ReadWriteMode, UART4CR1Base> ;
    using DEAT2 = UART4_CR1_DEAT2_Values<UART4::CR1, 23, 1, ReadWriteMode, UART4CR1Base> ;
    using DEAT1 = UART4_CR1_DEAT1_Values<UART4::CR1, 22, 1, ReadWriteMode, UART4CR1Base> ;
    using DEAT0 = UART4_CR1_DEAT0_Values<UART4::CR1, 21, 1, ReadWriteMode, UART4CR1Base> ;
    using DEDT4 = UART4_CR1_DEDT4_Values<UART4::CR1, 20, 1, ReadWriteMode, UART4CR1Base> ;
    using DEDT3 = UART4_CR1_DEDT3_Values<UART4::CR1, 19, 1, ReadWriteMode, UART4CR1Base> ;
    using DEDT2 = UART4_CR1_DEDT2_Values<UART4::CR1, 18, 1, ReadWriteMode, UART4CR1Base> ;
    using DEDT1 = UART4_CR1_DEDT1_Values<UART4::CR1, 17, 1, ReadWriteMode, UART4CR1Base> ;
    using DEDT0 = UART4_CR1_DEDT0_Values<UART4::CR1, 16, 1, ReadWriteMode, UART4CR1Base> ;
    ...
    using M0 = UART4_CR1_M0_Values<UART4::CR1, 12, 1, ReadWriteMode, UART4CR1Base> ;
  ...
  {
    using ADD4_7 = UART4_CR2_ADD4_7_Values<UART4::CR2, 28, 4, ReadWriteMode, UART4CR2Base> ;
    using ADD0_3 = UART4_CR2_ADD0_3_Values<UART4::CR2, 24, 4, ReadWriteMode, UART4CR2Base> ;
    using RTOEN = UART4_CR2_RTOEN_Values<UART4::CR2, 23, 1, ReadWriteMode, UART4CR2Base> ;
    using ABRMOD1 = UART4_CR2_ABRMOD1_Values<UART4::CR2, 22, 1, ReadWriteMode, UART4CR2Base> ;
    using ABRMOD0 = UART4_CR2_ABRMOD0_Values<UART4::CR2, 21, 1, ReadWriteMode, UART4CR2Base> ;
    ...
    using TAINV = UART4_CR2_TAINV_Values<UART4::CR2, 18, 1, ReadWriteMode, UART4CR2Base> ;
  ...
  struct RQR : public RegisterBase<0x40004C18, 32, WriteMode>
  {
    using TXFRQ = UART4_RQR_TXFRQ_Values<UART4::RQR, 4, 1, WriteMode, UART4RQRBase> ;
    using RXFRQ = UART4_RQR_RXFRQ_Values<UART4::RQR, 3, 1, WriteMode, UART4RQRBase> ;
    using MMRQ = UART4_RQR_MMRQ_Values<UART4::RQR, 2, 1, WriteMode, UART4RQRBase> ;
    using SBKRQ = UART4_RQR_SBKRQ_Values<UART4::RQR, 1, 1, WriteMode, UART4RQRBase> ;
    using ABRRQ = UART4_RQR_ABRRQ_Values<UART4::RQR, 0, 1, WriteMode, UART4RQRBase> ;
    using FieldValues = UART4_RQR_ABRRQ_Values<UART4::RQR, 0, 0, NoAccess, NoAccess> ;
  } ;

  template<typename... T> 
  using RQRPack  = Register<0x40004C18, 32, WriteMode, UART4RQRBase, T...> ;
  ...
  struct ICR : public RegisterBase<0x40004C20, 32, WriteMode>
  {
    using WUCF = UART4_ICR_WUCF_Values<UART4::ICR, 20, 1, WriteMode, UART4ICRBase> ;
    using CMCF = UART4_ICR_CMCF_Values<UART4::ICR, 17, 1, WriteMode, UART4ICRBase> ;
    using EOBCF = UART4_ICR_EOBCF_Values<UART4::ICR, 12, 1, WriteMode, UART4ICRBase> ;
    using RTOCF = UART4_ICR_RTOCF_Values<UART4::ICR, 11, 1, WriteMode, UART4ICRBase> ;
    using CTSCF = UART4_ICR_CTSCF_Values<UART4::ICR, 9, 1, WriteMode, UART4ICRBase> ;
    using LBDCF = UART4_ICR_LBDCF_Values<UART4::ICR, 8, 1, WriteMode, UART4ICRBase> ;
    using TCCF = UART4_ICR_TCCF_Values<UART4::ICR, 6, 1, WriteMode, UART4ICRBase> ;
    using IDLECF = UART4_ICR_IDLECF_Values<UART4::ICR, 4, 1, WriteMode, UART4ICRBase> ;
    using ORECF = UART4_ICR_ORECF_Values<UART4::ICR, 3, 1, WriteMode, UART4ICRBase> ;
    using NCF = UART4_ICR_NCF_Values<UART4::ICR, 2, 1, WriteMode, UART4ICRBase> ;
    using FECF = UART4_ICR_FECF_Values<UART4::ICR, 1, 1, WriteMode, UART4ICRBase> ;
    using PECF = UART4_ICR_PECF_Values<UART4::ICR, 0, 1, WriteMode, UART4ICRBase> ;
    using FieldValues = UART4_ICR_PECF_Values<UART4::ICR, 0, 0, NoAccess, NoAccess> ;
  } ;

  template<typename... T> 
  using ICRPack  = Register<0x40004C20, 32, WriteMode, UART4ICRBase, T...> ;
