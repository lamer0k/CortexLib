...
struct TIM1
{
  ...
  struct OR1 : public RegisterBase<0x40012C50, 32, ReadWriteMode>
  {
    using ETR_ADC1_RMP = TIM1_OR1_ETR_ADC1_RMP_Values<TIM1::OR1, 0, 2, ReadWriteMode, TIM1OR1Base> ;
    using ETR_ADC3_RMP = TIM1_OR1_ETR_ADC3_RMP_Values<TIM1::OR1, 2, 2, ReadWriteMode, TIM1OR1Base> ;
    using TI1_RMP = TIM1_OR1_TI1_RMP_Values<TIM1::OR1, 4, 1, ReadWriteMode, TIM1OR1Base> ;
    using FieldValues = TIM1_OR1_TI1_RMP_Values<TIM1::OR1, 0, 0, NoAccess, NoAccess> ;
  } ;

  template<typename... T> 
  using OR1Pack  = Register<0x40012C50, 32, ReadWriteMode, TIM1OR1Base, T...> ;
  ...
  struct CCMR3_Output : public RegisterBase<0x40012C54, 32, ReadWriteMode>
  {
    ...
    using OC5M_bit3 = TIM1_CCMR3_Output_OC5M_bit3_Values<TIM1::CCMR3_Output, 16, 3, ReadWriteMode, TIM1CCMR3_OutputBase> ;
  ...
  struct OR2 : public RegisterBase<0x40012C60, 32, ReadWriteMode>
  {
    using BKINE = TIM1_OR2_BKINE_Values<TIM1::OR2, 0, 1, ReadWriteMode, TIM1OR2Base> ;
    using BKCMP1E = TIM1_OR2_BKCMP1E_Values<TIM1::OR2, 1, 1, ReadWriteMode, TIM1OR2Base> ;
    using BKCMP2E = TIM1_OR2_BKCMP2E_Values<TIM1::OR2, 2, 1, ReadWriteMode, TIM1OR2Base> ;
    using BKDFBK0E = TIM1_OR2_BKDFBK0E_Values<TIM1::OR2, 8, 1, ReadWriteMode, TIM1OR2Base> ;
    using BKINP = TIM1_OR2_BKINP_Values<TIM1::OR2, 9, 1, ReadWriteMode, TIM1OR2Base> ;
    using BKCMP1P = TIM1_OR2_BKCMP1P_Values<TIM1::OR2, 10, 1, ReadWriteMode, TIM1OR2Base> ;
    using BKCMP2P = TIM1_OR2_BKCMP2P_Values<TIM1::OR2, 11, 1, ReadWriteMode, TIM1OR2Base> ;
    using ETRSEL = TIM1_OR2_ETRSEL_Values<TIM1::OR2, 14, 3, ReadWriteMode, TIM1OR2Base> ;
    using FieldValues = TIM1_OR2_ETRSEL_Values<TIM1::OR2, 0, 0, NoAccess, NoAccess> ;
  } ;

  template<typename... T> 
  using OR2Pack  = Register<0x40012C60, 32, ReadWriteMode, TIM1OR2Base, T...> ;

  struct TIM1OR3Base {} ;

  struct OR3 : public RegisterBase<0x40012C64, 32, ReadWriteMode>
  {
    using BK2INE = TIM1_OR3_BK2INE_Values<TIM1::OR3, 0, 1, ReadWriteMode, TIM1OR3Base> ;
    using BK2CMP1E = TIM1_OR3_BK2CMP1E_Values<TIM1::OR3, 1, 1, ReadWriteMode, TIM1OR3Base> ;
    using BK2CMP2E = TIM1_OR3_BK2CMP2E_Values<TIM1::OR3, 2, 1, ReadWriteMode, TIM1OR3Base> ;
    using BK2DFBK0E = TIM1_OR3_BK2DFBK0E_Values<TIM1::OR3, 8, 1, ReadWriteMode, TIM1OR3Base> ;
    using BK2INP = TIM1_OR3_BK2INP_Values<TIM1::OR3, 9, 1, ReadWriteMode, TIM1OR3Base> ;
    using BK2CMP1P = TIM1_OR3_BK2CMP1P_Values<TIM1::OR3, 10, 1, ReadWriteMode, TIM1OR3Base> ;
    using BK2CMP2P = TIM1_OR3_BK2CMP2P_Values<TIM1::OR3, 11, 1, ReadWriteMode, TIM1OR3Base> ;
    using FieldValues = TIM1_OR3_BK2CMP2P_Values<TIM1::OR3, 0, 0, NoAccess, NoAccess> ;
  } ;

  template<typename... T> 
  using OR3Pack  = Register<0x40012C64, 32, ReadWriteMode, TIM1OR3Base, T...> ;
