...
struct SPI5
{
  ...
  struct CR1 : public RegisterBase<0x40015000, 32, ReadWriteMode>
  {
    ...
    using FieldValues = SPI_CR_CPHA_Values<SPI5::CR1, 0, 0, NoAccess, NoAccess> ;
  } ;
  ...
  struct CR2 : public RegisterBase<0x40015004, 32, ReadWriteMode>
  {
    ...
    using FieldValues = SPI_CR_RXDMAEN_Values<SPI5::CR2, 0, 0, NoAccess, NoAccess> ;
  } ;
  ...
  struct SR : public RegisterBase<0x40015008, 32, ReadWriteMode>
  {
    ...
    using FieldValues = SPI_SR_RXNE_Values<SPI5::SR, 0, 0, NoAccess, NoAccess> ;
  } ;
  ...
  struct DR : public RegisterBase<0x4001500C, 32, ReadWriteMode>
  {
    ...
    using FieldValues = SPI_DR_DR_Values<SPI5::DR, 0, 0, NoAccess, NoAccess> ;
  } ;
  ...
  struct CRCPR : public RegisterBase<0x40015010, 32, ReadWriteMode>
  {
    ...
    using FieldValues = SPI_CRCPR_CRCPOLY_Values<SPI5::CRCPR, 0, 0, NoAccess, NoAccess> ;
  } ;
  ...
  struct RXCRCR : public RegisterBase<0x40015014, 32, ReadMode>
  {
    ...
    using FieldValues = SPI_RXCRCR_RxCRC_Values<SPI5::RXCRCR, 0, 0, NoAccess, NoAccess> ;
  } ;
  ...
  struct TXCRCR : public RegisterBase<0x40015018, 32, ReadMode>
  {
    ...
    using FieldValues = SPI_TXCRCR_TxCRC_Values<SPI5::TXCRCR, 0, 0, NoAccess, NoAccess> ;
  } ;
  ...
  struct I2SCFGR : public RegisterBase<0x4001501C, 32, ReadWriteMode>
  {
    ...
    using FieldValues = SPI_ISCFGR_CHLEN_Values<SPI5::I2SCFGR, 0, 0, NoAccess, NoAccess> ;
  } ;
  ...
  struct I2SPR : public RegisterBase<0x40015020, 32, ReadWriteMode>
  {
    ...
    using FieldValues = SPI_ISPR_ISDIV_Values<SPI5::I2SPR, 0, 0, NoAccess, NoAccess> ;
  } ;
