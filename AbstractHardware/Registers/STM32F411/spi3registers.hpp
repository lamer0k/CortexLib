...
struct SPI3
{
  ...
  struct CR1 : public RegisterBase<0x40003C00, 32, ReadWriteMode>
  {
    ...
    using FieldValues = SPI_CR_CPHA_Values<SPI3::CR1, 0, 0, NoAccess, NoAccess> ;
  } ;
  ...
  struct CR2 : public RegisterBase<0x40003C04, 32, ReadWriteMode>
  {
    ...
    using FieldValues = SPI_CR_RXDMAEN_Values<SPI3::CR2, 0, 0, NoAccess, NoAccess> ;
  } ;
  ...
  struct SR : public RegisterBase<0x40003C08, 32, ReadWriteMode>
  {
    ...
    using FieldValues = SPI_SR_RXNE_Values<SPI3::SR, 0, 0, NoAccess, NoAccess> ;
  } ;
  ...
  struct DR : public RegisterBase<0x40003C0C, 32, ReadWriteMode>
  {
    ...
    using FieldValues = SPI_DR_DR_Values<SPI3::DR, 0, 0, NoAccess, NoAccess> ;
  } ;
  ...
  struct CRCPR : public RegisterBase<0x40003C10, 32, ReadWriteMode>
  {
    ...
    using FieldValues = SPI_CRCPR_CRCPOLY_Values<SPI3::CRCPR, 0, 0, NoAccess, NoAccess> ;
  } ;
  ...
  struct RXCRCR : public RegisterBase<0x40003C14, 32, ReadMode>
  {
    ...
    using FieldValues = SPI_RXCRCR_RxCRC_Values<SPI3::RXCRCR, 0, 0, NoAccess, NoAccess> ;
  } ;
  ...
  struct TXCRCR : public RegisterBase<0x40003C18, 32, ReadMode>
  {
    ...
    using FieldValues = SPI_TXCRCR_TxCRC_Values<SPI3::TXCRCR, 0, 0, NoAccess, NoAccess> ;
  } ;
  ...
  struct I2SCFGR : public RegisterBase<0x40003C1C, 32, ReadWriteMode>
  {
    ...
    using FieldValues = SPI_ISCFGR_CHLEN_Values<SPI3::I2SCFGR, 0, 0, NoAccess, NoAccess> ;
  } ;
  ...
  struct I2SPR : public RegisterBase<0x40003C20, 32, ReadWriteMode>
  {
    ...
    using FieldValues = SPI_ISPR_ISDIV_Values<SPI3::I2SPR, 0, 0, NoAccess, NoAccess> ;
  } ;
