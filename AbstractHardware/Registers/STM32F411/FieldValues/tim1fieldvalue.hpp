...
{
  using Divider1 = FieldValue<Reg, offset, size, AccessMode, BaseType, 0U> ;
  using Divider2 = FieldValue<Reg, offset, size, AccessMode, BaseType, 1U> ;
  using Divider4 = FieldValue<Reg, offset, size, AccessMode, BaseType, 2U> ;
  using Reserved = FieldValue<Reg, offset, size, AccessMode, BaseType, 3U> ;
} ;
...
{
  using Upcounter = FieldValue<Reg, offset, size, AccessMode, BaseType, 0U> ;
  using Downcounter = FieldValue<Reg, offset, size, AccessMode, BaseType, 1U> ;
} ;
...
{
  using Disable = FieldValue<Reg, offset, size, AccessMode, BaseType, 0U> ;
  using Enable = FieldValue<Reg, offset, size, AccessMode, BaseType, 1U> ;
} ;
