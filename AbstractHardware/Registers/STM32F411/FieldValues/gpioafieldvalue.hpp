...
{
  using Input = FieldValue<Reg, offset, size, AccessMode, BaseType, 0U> ;
  using Output = FieldValue<Reg, offset, size, AccessMode, BaseType, 1U> ;
  using Alternate = FieldValue<Reg, offset, size, AccessMode, BaseType, 2U> ;
  using Analog = FieldValue<Reg, offset, size, AccessMode, BaseType, 3U> ;
} ;
...
{
  using Notused = FieldValue<Reg, offset, size, AccessMode, BaseType, 0U> ;
  using Reset = FieldValue<Reg, offset, size, AccessMode, BaseType, 1U> ;
} ;
...
{
  using Notused = FieldValue<Reg, offset, size, AccessMode, BaseType, 0U> ;
  using Set = FieldValue<Reg, offset, size, AccessMode, BaseType, 1U> ;
} ;
