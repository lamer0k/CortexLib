...
struct TIM2
{
  ...
  {
    using DMARField = TIM2_DMAR_DMAR_Values<TIM2::DMAR, 0, 16, ReadWriteMode, TIM2DMARBase> ;
    using FieldValues = TIM2_DMAR_DMAR_Values<TIM2::DMAR, 0, 0, NoAccess, NoAccess> ;
  } ;
