...
template <typename Reg, size_t offset, size_t size, typename AccessMode, typename BaseType> 
struct TIM14_OR_RMP_Values: public RegisterField<Reg, offset, size, AccessMode> 
{
  using Value0 = FieldValue<TIM14_OR_RMP_Values, BaseType, 0U> ;
  using Value1 = FieldValue<TIM14_OR_RMP_Values, BaseType, 1U> ;
  using Value2 = FieldValue<TIM14_OR_RMP_Values, BaseType, 2U> ;
  using Value3 = FieldValue<TIM14_OR_RMP_Values, BaseType, 3U> ;
} ;
