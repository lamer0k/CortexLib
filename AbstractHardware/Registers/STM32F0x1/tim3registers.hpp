...
struct TIM3
{
  ...
  {
    using DMARField = TIM3_DMAR_DMAR_Values<TIM3::DMAR, 0, 16, ReadWriteMode, TIM3DMARBase> ;
    using FieldValues = TIM3_DMAR_DMAR_Values<TIM3::DMAR, 0, 0, NoAccess, NoAccess> ;
  } ;
