...
*
* Details       : Flash. This header file is auto-generated for STM32F0x1
*                 device.
*
*
*******************************************************************************/
...
struct Flash
{
  ...
  struct OBR : public RegisterBase<0x4002201C, 32, ReadMode>
  {
    ...
    using RDPRT = Flash_OBR_RDPRT_Values<Flash::OBR, 1, 2, ReadMode, FlashOBRBase> ;
    ...
    using nBOOT0 = Flash_OBR_nBOOT0_Values<Flash::OBR, 11, 1, ReadMode, FlashOBRBase> ;
    using nBOOT1 = Flash_OBR_nBOOT1_Values<Flash::OBR, 12, 1, ReadMode, FlashOBRBase> ;
    using VDDA_MONITOR = Flash_OBR_VDDA_MONITOR_Values<Flash::OBR, 13, 1, ReadMode, FlashOBRBase> ;
    using RAM_PARITY_CHECK = Flash_OBR_RAM_PARITY_CHECK_Values<Flash::OBR, 14, 0, ReadMode, FlashOBRBase> ;
    using BOOT_SEL = Flash_OBR_BOOT_SEL_Values<Flash::OBR, 15, 1, ReadMode, FlashOBRBase> ;
