...
struct RTC
{
  ...
  struct TAFCR : public RegisterBase<0x40002840, 32, ReadWriteMode>
  {
    ...
    using TAMP3E = RTC_TAFCR_TAMP3E_Values<RTC::TAFCR, 5, 1, ReadWriteMode, RTCTAFCRBase> ;
    using TAMP3TRG = RTC_TAFCR_TAMP3TRG_Values<RTC::TAFCR, 6, 1, ReadWriteMode, RTCTAFCRBase> ;
    ...
    using FieldValues = RTC_TAFCR_PC15MODE_Values<RTC::TAFCR, 0, 0, NoAccess, NoAccess> ;
  } ;
